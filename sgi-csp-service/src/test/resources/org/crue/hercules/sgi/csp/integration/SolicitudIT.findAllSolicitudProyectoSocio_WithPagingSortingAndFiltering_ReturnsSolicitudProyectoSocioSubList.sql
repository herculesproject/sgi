...
INSERT INTO csp.solicitud (id, codigo_externo, codigo_registro_interno, estado_solicitud_id, convocatoria_id, creador_ref, solicitante_ref, observaciones, convocatoria_externa, unidad_gestion_ref, formulario_solicitud, activo)
 VALUES (2, null, 'SGI_SLC1202011061028', null, 1, 'usr-001', 'usr-002', 'observaciones 1', null, 'OPE', 'ESTANDAR', true);
INSERT INTO csp.solicitud (id, codigo_externo, codigo_registro_interno, estado_solicitud_id, convocatoria_id, creador_ref, solicitante_ref, observaciones, convocatoria_externa, unidad_gestion_ref, formulario_solicitud, activo)
 VALUES (3, null, 'SGI_SLC1202011061029', null, 1, 'usr-001', 'usr-002', 'observaciones 1', null, 'OPE', 'ESTANDAR', true);
INSERT INTO csp.solicitud (id, codigo_externo, codigo_registro_interno, estado_solicitud_id, convocatoria_id, creador_ref, solicitante_ref, observaciones, convocatoria_externa, unidad_gestion_ref, formulario_solicitud, activo)
 VALUES (4, null, 'SGI_SLC1202011061026', null, 1, 'usr-001', 'usr-002', 'observaciones 1', null, 'OPE', 'ESTANDAR', true);
...
INSERT INTO csp.solicitud_proyecto (id, titulo, colaborativo, presupuesto_por_entidades ) 
VALUES (3, 'titulo-3', true, true);
INSERT INTO csp.solicitud_proyecto (id, titulo, colaborativo, presupuesto_por_entidades ) 
VALUES (4, 'titulo-4', true, true);
