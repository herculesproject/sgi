...
values(NEXTVAL('CSP.convocatoria_periodo_seguimiento_cientifico_seq'), 1, 1, 3, 4, '2020-03-01', '2020-04-01', 'observaciones-meses-03-04');

insert into csp.convocatoria_periodo_seguimiento_cientifico
(id, convocatoria_id, num_periodo, mes_inicial, mes_final, fecha_inicio_presentacion, fecha_fin_presentacion, observaciones)
values(NEXTVAL('CSP.convocatoria_periodo_seguimiento_cientifico_seq'), 1, 2, 5, 6, '2020-05-01', '2020-06-01', 'observaciones-meses-05-06');

insert into csp.convocatoria_periodo_seguimiento_cientifico
(id, convocatoria_id, num_periodo, mes_inicial, mes_final, fecha_inicio_presentacion, fecha_fin_presentacion, observaciones)
values(NEXTVAL('CSP.convocatoria_periodo_seguimiento_cientifico_seq'), 1, 3, 7, 8, '2020-07-01', '2020-08-01', 'observaciones-meses-07-08');
