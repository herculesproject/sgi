...
INSERT INTO csp.proyecto (id, titulo, codigo_externo, fecha_inicio, fecha_fin, unidad_gestion_ref, modelo_ejecucion_id, tipo_finalidad_id, tipo_ambito_geografico_id, confidencial, observaciones, estado_proyecto_id, activo)
  VALUES (1, 'PRO1', 'cod-externo-001', '2020-12-12', '2020-12-31', 'OPE', 1, 1, 1, false, 'observaciones 1', 1, true);
INSERT INTO csp.proyecto (id, titulo, codigo_externo, fecha_inicio, fecha_fin, unidad_gestion_ref, modelo_ejecucion_id, tipo_finalidad_id, tipo_ambito_geografico_id, confidencial, observaciones, estado_proyecto_id, activo)
  VALUES (2, 'PRO2', 'cod-externo-002', '2020-12-12', '2020-12-31', 'OPE', 1, 1, 1, false, 'observaciones 2', 1, true);
...
INSERT INTO csp.proyecto_socio (id, proyecto_id, empresa_ref, rol_socio_id, fecha_inicio, fecha_fin, num_investigadores, importe_concedido)
  VALUES (1, 1, 'empresa-001', 1, '2021-01-11', '2022-01-11', 5, 1000);
INSERT INTO csp.proyecto_socio (id, proyecto_id, empresa_ref, rol_socio_id, fecha_inicio, fecha_fin, num_investigadores, importe_concedido)
  VALUES (2, 1, 'empresa-002', 1, '2021-02-11', '2022-02-11', 10, 2000);
INSERT INTO csp.proyecto_socio (id, proyecto_id, empresa_ref, rol_socio_id, fecha_inicio, fecha_fin, num_investigadores, importe_concedido)
  VALUES (3, 1, 'empresa-003', 1, '2021-03-11', '2022-03-11', 15, 3000);
INSERT INTO csp.proyecto_socio (id, proyecto_id, empresa_ref, rol_socio_id, fecha_inicio, fecha_fin, num_investigadores, importe_concedido)
  VALUES (4, 2, 'empresa-004', 1, '2021-04-11', '2022-04-11', 20, 4000);
INSERT INTO csp.proyecto_socio (id, proyecto_id, empresa_ref, rol_socio_id, fecha_inicio, fecha_fin, num_investigadores, importe_concedido)
  VALUES (11, 1, 'empresa-011', 1, '2021-11-11', '2022-11-11', 55, 11000);
