...
-- SOLICITUD
INSERT INTO test.solicitud (id, codigo_externo, codigo_registro_interno, estado_solicitud_id, convocatoria_id, creador_ref, solicitante_ref, observaciones, convocatoria_externa, unidad_gestion_ref, formulario_solicitud, origen_solicitud, activo)
 VALUES (1, null, 'SGI_SLC1202011061027', null, 1, 'usr-001', 'usr-002', 'observaciones 1', null, '2', 'PROYECTO', 'CONVOCATORIA_SGI', true);
