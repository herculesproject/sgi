...
(id, abreviatura, descripcion, rol_principal, orden, equipo, activo, baremable_prc) 
VALUES
(1, '001', 'descripcion-001', true, 'PRIMARIO',   'INVESTIGACION', true,  true),
(2, '002', 'descripcion-002', true, 'SECUNDARIO', 'INVESTIGACION', true,  true),
(3, '003', 'descripcion-003', false, null,        'INVESTIGACION', true,  true),
(4, '004', 'descripcion-4',   false, null,        'INVESTIGACION', true,  true),
(5, '005', 'descripcion-5',   false, null,        'INVESTIGACION', true,  true),
(6, '006', 'descripcion-6',   false, null,        'INVESTIGACION', true,  true),
(7, '007', 'descripcion-007', false, null,        'INVESTIGACION', false, true),
(8, '008', 'descripcion-008', false, null,        'INVESTIGACION', false, true);
