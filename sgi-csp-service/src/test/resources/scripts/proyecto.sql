...
-- PROYECTO
INSERT INTO test.proyecto (id, codigo_externo, fecha_inicio, fecha_fin, unidad_gestion_ref, modelo_ejecucion_id, tipo_finalidad_id, tipo_ambito_geografico_id, tipo_confidencialidad_id, estado_proyecto_id, paquetes_trabajo, activo)
VALUES (1, 'cod-externo-001', '2020-01-12T00:00:00Z', '2021-12-31T23:59:59Z', '2', 1, 1, 1, null, null, false, true);

INSERT INTO test.proyecto (id, codigo_externo, fecha_inicio, fecha_fin, unidad_gestion_ref, modelo_ejecucion_id, tipo_finalidad_id, tipo_ambito_geografico_id, tipo_confidencialidad_id, estado_proyecto_id, paquetes_trabajo, activo)
VALUES (2, 'cod-externo-002', '2020-01-01T00:00:00Z', '2020-12-31T23:59:59Z', '2', 1, 1, 1, null, null, true, true);

INSERT INTO test.proyecto (id, codigo_externo, fecha_inicio, fecha_fin, unidad_gestion_ref, modelo_ejecucion_id, tipo_finalidad_id, tipo_ambito_geografico_id, tipo_confidencialidad_id, estado_proyecto_id, paquetes_trabajo, activo)
VALUES (3, 'cod-externo-003', '2020-01-01T00:00:00Z', '2020-12-31T23:59:59Z', '2', 1, 1, 1, null, null, true, true);

INSERT INTO test.proyecto (id, codigo_externo, fecha_inicio, fecha_fin, unidad_gestion_ref, modelo_ejecucion_id, tipo_finalidad_id, tipo_ambito_geografico_id, tipo_confidencialidad_id, estado_proyecto_id, paquetes_trabajo, activo, convocatoria_id)
VALUES (4, 'cod-externo-004', '2020-01-01T00:00:00Z', '2021-12-31T23:59:59Z', '1', 1, 1, 1, null, null, true, true, 1);

INSERT INTO test.proyecto (id, codigo_externo, fecha_inicio, fecha_fin, unidad_gestion_ref, modelo_ejecucion_id, tipo_finalidad_id, tipo_ambito_geografico_id, tipo_confidencialidad_id, estado_proyecto_id, paquetes_trabajo, activo)
VALUES (5, 'cod-externo-005', '2020-01-01T00:00:00Z', '2020-12-31T23:59:59Z', '2', 1, 1, 1, null, null, true, false);
