...
INSERT INTO test.gasto_requerimiento_justificacion (id, gasto_ref, requerimiento_justificacion_id, importe_aceptado, importe_rechazado, importe_alegado, aceptado, alegacion, identificador_justificacion)
VALUES(1, 'gasto-ref-001', 1, 100.50, 200.54, 400, true, 'alegacion-001', '11/1111');
INSERT INTO test.gasto_requerimiento_justificacion (id, gasto_ref, requerimiento_justificacion_id, importe_aceptado, importe_rechazado, importe_alegado, aceptado, alegacion, identificador_justificacion)
VALUES(2, 'gasto-ref-002', 1, 200.50, 100.54, 300, true, 'alegacion-002', '11/1111');
INSERT INTO test.gasto_requerimiento_justificacion (id, gasto_ref, requerimiento_justificacion_id, importe_aceptado, importe_rechazado, importe_alegado, aceptado, alegacion, identificador_justificacion)
VALUES(3, 'gasto-ref-003', 1, 222.52, 444.44, 444, true, 'alegacion-003', '11/1111');
INSERT INTO test.gasto_requerimiento_justificacion (id, gasto_ref, requerimiento_justificacion_id, importe_aceptado, importe_rechazado, importe_alegado, aceptado, alegacion, identificador_justificacion)
VALUES(4, 'gasto-ref-004', 2, 1320.00, 200.00, 1400, true, 'alegacion-001', '22/1111');
INSERT INTO test.gasto_requerimiento_justificacion (id, gasto_ref, requerimiento_justificacion_id, importe_aceptado, importe_rechazado, importe_alegado, aceptado, alegacion, identificador_justificacion)
VALUES(5, 'gasto-ref-005', 2, 10.50, 20.54, 40, true, 'alegacion-002', '22/1111');
