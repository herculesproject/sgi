...
public class TipoFinanciacionServiceTest {
  ...
  public void setUp() throws Exception {
    tipoFinanciacionService = new TipoFinanciacionServiceImpl(tipoFinanciacionRepository);
  }

  @Test
  public void findById_WithId_ReturnsTipoFinanciacion() {
    BDDMockito.given(tipoFinanciacionRepository.findById(1L))
        .willReturn(Optional.of(generarMockTipoFinanciacion(1L, "TipoFinanciacion1")));

    TipoFinanciacion tipoFinanciacion = tipoFinanciacionService.findById(1L);
  ...
  public void findById_WithIdNotExist_ThrowsTipoFinanciacionNotFoundException() throws Exception {
    BDDMockito.given(tipoFinanciacionRepository.findById(1L)).willReturn(Optional.empty());

    Assertions.assertThatThrownBy(() -> tipoFinanciacionService.findById(1L))
  ...
  public void create_ReturnsTipoFinanciacion() {
    ...
    BDDMockito.given(tipoFinanciacionRepository.findByNombre(tipoFinanciacion.getNombre()))
        .willReturn(Optional.empty());

    BDDMockito.given(tipoFinanciacionRepository.save(tipoFinanciacion)).will((InvocationOnMock invocation) -> {
    ...
    TipoFinanciacion tipoFinanciacionCreado = tipoFinanciacionService.create(tipoFinanciacion);
  ...
  public void update_ReturnsTipoFinanciacion() {
    ...
    BDDMockito.given(tipoFinanciacionRepository.findById(1L)).willReturn(Optional.of(tipoFinanciacion));
  ...
  public void update_ThrowsTipoFinanciacionNotFoundException() {
    ...
    Assertions.assertThatThrownBy(() -> tipoFinanciacionService.update(tipoFinanciacion))
        .isInstanceOf(TipoFinanciacionNotFoundException.class);
  ...
  public void delete_WithoutId_ThrowsIllegalArgumentException() {
    ...
    Assertions.assertThatThrownBy(
        // when: Delete sin id
        () -> tipoFinanciacionService.disable(null))
  ...
  public void create_WithDuplicatedNombre_ThrowsIllegalArgumentException() {
    ...
    BDDMockito.given(tipoFinanciacionRepository.findByNombre(ArgumentMatchers.anyString()))
        .willReturn(Optional.of(givenData));

    Assertions.assertThatThrownBy(
        // when: create TipoFinanciacion
        () -> tipoFinanciacionService.create(newTFinanciacion))
  ...
  public void update_WithDuplicatedNombre_ThrowsIllegalArgumentException() {
    ...
    BDDMockito.given(tipoFinanciacionRepository.findByNombre(tipoFinanciacionUpdated.getNombre()))
    ...
    // nombre
    Assertions.assertThatThrownBy(() -> tipoFinanciacionService.update(tipoFinanciacionUpdated))
        .isInstanceOf(IllegalArgumentException.class);
  }
