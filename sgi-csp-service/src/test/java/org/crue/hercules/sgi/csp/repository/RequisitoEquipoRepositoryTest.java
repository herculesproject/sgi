...
public class RequisitoEquipoRepositoryTest {
  ...
  public void findByConvocatoriaId_ReturnsRequisitoEquipo() throws Exception {
    ...
    Convocatoria convocatoria1 = entityManager.persistAndFlush(Convocatoria.builder().codigo("codigo-1")
    ...
    Convocatoria convocatoria2 = entityManager.persistAndFlush(Convocatoria.builder().codigo("codigo-2")
        .estadoActual(TipoEstadoConvocatoriaEnum.BORRADOR).activo(Boolean.TRUE).build());
  ...
  public void findByConvocatoriaNoExiste_ReturnsNull() throws Exception {
    ...
    entityManager.persistAndFlush(new RequisitoEquipo(null, convocatoria1, "na-001", 4, 48, 6, false, "mc-001", 2, 10, 10, 15, 15, "otros"));

    Convocatoria convocatoria2 = entityManager.persistAndFlush(Convocatoria.builder().codigo("codigo-2")
        .estadoActual(TipoEstadoConvocatoriaEnum.BORRADOR).activo(Boolean.TRUE).build());
    entityManager.persistAndFlush(new RequisitoEquipo(null, convocatoria2, "na-001", 4, 48, 6, false, "mc-001", 2, 10, 10, 15, 15, "otros"));
