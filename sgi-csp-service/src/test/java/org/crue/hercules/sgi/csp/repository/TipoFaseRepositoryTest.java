 ...
 */
@DataJpaTest
public class TipoFaseRepositoryTest {
  ...
  @Test
  public void findByNombre_ReturnsTipoFase() throws Exception {
    ...
    Assertions.assertThat(tipoFaseEncontrado.getActivo()).as("getActivo").isEqualTo(tipoFase1.getActivo());
  }
