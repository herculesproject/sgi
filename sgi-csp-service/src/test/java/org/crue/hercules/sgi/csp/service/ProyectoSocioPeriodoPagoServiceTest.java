...
class ProyectoSocioPeriodoPagoServiceTest extends BaseServiceTest {
  ...
  void setUp() throws Exception {
    service = new ProyectoSocioPeriodoPagoServiceImpl(repository, proyectoSocioRepository, proyectoHelper);
  }
  ...
  void update_WithProyectoSocioChange_ThrowsIllegalArgumentException() {
    ...
    Assertions.assertThatThrownBy(() -> service.update(proyectoSocioId, Arrays.asList(proyectoPeriodoPago)))
        ...
        .hasMessage("No se puede Modificar Proyecto Socio para Proyecto Socio Periodo Pago");
  }
