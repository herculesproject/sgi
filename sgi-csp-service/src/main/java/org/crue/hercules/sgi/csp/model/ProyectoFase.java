...
public class ProyectoFase extends BaseEntity {
  ...
  @CollectionTable(name = "proyecto_fase_observaciones", joinColumns = @JoinColumn(name = "proyecto_id"))
  @Valid
  @Builder.Default
  private Set<ProyectoFaseObservaciones> observaciones = new HashSet<>();
