...
public class SolicitudHitoController {
  ...
  /**
   * Comprueba la existencia del {@link SolicitudHito} con el id indicado.
   * 
  ...
  public ResponseEntity<?> exists(@PathVariable Long id) {
    log.debug("SolicitudHito exists(Long id) - start");
    if (service.existsById(id)) {
      log.debug("SolicitudHito exists(Long id) - end");
