...
public class ConvocatoriaConceptoGastoCodigoEc extends BaseEntity {
  ...
  @CollectionTable(name = "convocatoria_concepto_gasto_codigo_ec_observaciones", joinColumns = @JoinColumn(name = "convocatoria_concepto_gasto_codigo_ec_id"))
  @Valid
  @Builder.Default
  private Set<ConvocatoriaConceptoGastoCodigoEcObservaciones> observaciones = new HashSet<>();
