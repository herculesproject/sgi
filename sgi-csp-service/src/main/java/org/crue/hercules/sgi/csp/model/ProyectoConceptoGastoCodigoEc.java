...
public class ProyectoConceptoGastoCodigoEc extends BaseEntity {
  ...
  @CollectionTable(name = "proyecto_concepto_gasto_codigo_ec_observaciones", joinColumns = @JoinColumn(name = "proyecto_concepto_gasto_codigo_ec_id"))
  @Valid
  @Builder.Default
  private Set<ProyectoConceptoGastoCodigoEcObservaciones> observaciones = new HashSet<>();
