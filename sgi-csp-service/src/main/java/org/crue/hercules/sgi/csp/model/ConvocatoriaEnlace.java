...
public class ConvocatoriaEnlace extends BaseEntity {
  ...
  @CollectionTable(name = "convocatoria_enlace_descripcion", joinColumns = @JoinColumn(name = "convocatoria_enlace_id"))
  @Valid
  @Builder.Default
  private Set<ConvocatoriaEnlaceDescripcion> descripcion = new HashSet<>();
