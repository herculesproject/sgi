...
public class EstadoProyecto extends BaseEntity {
  ...
  @CollectionTable(name = "estado_proyecto_comentario", joinColumns = @JoinColumn(name = "estado_proyecto_id"))
  @Valid
  @Builder.Default
  private Set<EstadoProyectoComentario> comentario = new HashSet<>();
