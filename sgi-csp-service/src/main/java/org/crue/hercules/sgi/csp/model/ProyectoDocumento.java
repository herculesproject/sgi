...
public class ProyectoDocumento extends BaseEntity {
  ...
  @CollectionTable(name = "proyecto_documento_nombre", joinColumns = @JoinColumn(name = "proyecto_documento_id"))
  @NotEmpty
  @Valid
  @Builder.Default
  private Set<ProyectoDocumentoNombre> nombre = new HashSet<>();
  ...
  /** Comentario. */
  @ElementCollection(fetch = FetchType.EAGER)
  @CollectionTable(name = "proyecto_documento_comentario", joinColumns = @JoinColumn(name = "proyecto_documento_id"))
  @Valid
  @Builder.Default
  private Set<ProyectoDocumentoComentario> comentario = new HashSet<>();
