...
public class ProyectoProyectoSgeNoDeletableException extends ProblemException {

  public ProyectoProyectoSgeNoDeletableException() {
    super(Problem.builder().type(ProblemExceptionHandler.VALIDATION_PROBLEM_TYPE)
        ...
        .detail(ProblemMessage.builder().key(ProyectoProyectoSgeNoDeletableException.class).build())
