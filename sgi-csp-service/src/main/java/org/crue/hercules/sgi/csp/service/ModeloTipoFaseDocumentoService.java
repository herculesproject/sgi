...
/**
 * Service Interface para gestionar {@link ModeloTipoFaseDocumento}.
 */

public interface ModeloTipoFaseDocumentoService {
   ...
   */
  Page<ModeloTipoFaseDocumento> findAllByModeloEjecucion(Long idModeloEjecucion, List<QueryCriteria> query,
      Pageable pageable);
