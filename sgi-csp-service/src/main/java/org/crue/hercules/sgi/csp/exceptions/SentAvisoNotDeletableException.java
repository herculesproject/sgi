...
/**
 * Se intenta eliminar un aviso que ya ha sido enviado.
 */
public class SentAvisoNotDeletableException extends ProblemException {
  ...
  public SentAvisoNotDeletableException() {
    super(Problem.builder().type(ProblemExceptionHandler.VALIDATION_PROBLEM_TYPE)
        ...
        .detail(ProblemMessage.builder().key(SentAvisoNotDeletableException.class).build())
