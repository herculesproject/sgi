...
public class ConfigController {
  ...
  @PreAuthorize("(isClient() and hasAuthority('SCOPE_sgi-cnf')) or hasAnyAuthorityForAnyUO('ADM-CNF-E', 'CSP-EJEC-V', 'CSP-EJEC-E', 'CSP-EJEC-INV-VR', 'CSP-GIN-E', 'CSP-GIN-V', 'CSP-GIN-INV-VR')")
