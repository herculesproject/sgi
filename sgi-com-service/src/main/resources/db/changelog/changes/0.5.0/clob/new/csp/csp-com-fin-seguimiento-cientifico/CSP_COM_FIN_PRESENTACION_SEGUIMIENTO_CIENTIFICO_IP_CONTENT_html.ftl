...
<p>Le informamos de que próximamente finalizará el plazo de presentación de la documentación de seguimiento científico del proyecto abajo indicado:</p>
<p>
- Proyecto: ${sgi.getFieldValue(data.titulo)}<br>
- Fecha de fin de presentación de documentación: ${sgi.formatDate(data.fechaFin, "SHORT")}, ${sgi.formatTime(data.fechaFin, "SHORT")}<br>
...
<#setting locale="en">
<p>Dear Researcher,</p>
<p>Please be advised that the deadline for the submission of the scientific follow-up documentation for the project below is approaching:</p>
<p>
- Project: ${sgi.getFieldValue(data.titulo)}<br>
- End date for submission of documentation: ${sgi.formatDate(data.fechaFin, "SHORT")}, ${sgi.formatTime(data.fechaFin, "SHORT")}<br>
...
<p>Honen bidez jakinarazten dizugu laster amaituko dela behean aipatutako proiektuaren jarraipen zientifikorako dokumentazioa aurkezteko epea:</p>
<p>
- Proiektua: ${sgi.getFieldValue(data.titulo)}<br>
- Dokumentazioa aurkezteko epearen amaiera: ${sgi.formatDate(data.fechaFin, "SHORT")}, ${sgi.formatTime(data.fechaFin, "SHORT")}<br>
