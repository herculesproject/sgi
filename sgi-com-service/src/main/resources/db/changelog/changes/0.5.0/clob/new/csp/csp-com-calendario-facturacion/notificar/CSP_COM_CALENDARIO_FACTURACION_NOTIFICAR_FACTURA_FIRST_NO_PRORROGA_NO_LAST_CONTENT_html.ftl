...
<p>Una vez firmado el contrato asocado al/los proyecto/s abajo referenciado/s más abajo, es necesario que confirme si pueden ser emitida la factura que se indica:</p>
<p>
