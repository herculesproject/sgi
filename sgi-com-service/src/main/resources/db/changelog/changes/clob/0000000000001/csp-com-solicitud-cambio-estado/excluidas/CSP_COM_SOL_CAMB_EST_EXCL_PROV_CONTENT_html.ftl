<#assign data = CSP_COM_SOL_CAMB_EST_EXCL_PROV_DATA?eval />
<!DOCTYPE html>
<html>
  <head>
  ...
  <body>
    ...
    <p>le informamos que con fecha ${data.fechaProvisionalConvocatoria?datetime.iso?string("dd/MM/yyyy")} se ha publicado la “Resolución con carácter provisional de Admitidos y Excluidos” de la convocatoria de ${data.tituloConvocatoria} en la que su solicitud aparece excluida.</p>
