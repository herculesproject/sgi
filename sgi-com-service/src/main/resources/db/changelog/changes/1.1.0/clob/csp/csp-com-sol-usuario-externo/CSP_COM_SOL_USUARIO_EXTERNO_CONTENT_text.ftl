...
Us informem que la vostra sol·licitud associada a la convocatòria baix referenciada ha estat creada en estat "esborrany".

- Convocatòria: ${sgi.getFieldValue(data.tituloConvocatoria)}

Podeu consultar l'estat de la mateixa des de l'aplicació, mitjançant les següents instruccions:

- Enllaç d'accés: ${data.enlaceAplicacion}
- Identificació: el vostre número de document d'identificació personal
