...
<p>Le informamos de que se ha publicado la resolución provisional de la convocatoria abajo referenciada en la que su solicitud aparece propuesta para financiación:</p>
<p>
...
<#setting locale="en">
<p>Dear researcher,</p>
<p>Please be advised that the provisional resolution of the below call has been published and your application has been proposed for funding:</p>
<p>
...
<p>Honen bidez jakinarazten dizugu behean aipatutako deialdiaren behin-behineko ebazpena argitaratu dela eta bertan zure eskaera finantzatzea proposatzen dela:</p>
<p>
...
<p>Us informem que s'ha publicat la resolució provisional de la convocatòria sota referenciada en què la vostra sol·licitud apareix proposada per a finançament:</p>
<p>
- Data de la resolució: <#if (data.fechaProvisionalConvocatoria)?has_content>${sgi.formatDate(data.fechaProvisionalConvocatoria, "SHORT")}<#else>-</#if><br>
