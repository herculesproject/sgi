...
<#macro renderCa>
<#setting locale="ca">
Us informem que teniu el vistiplau per a l'emissió de la factura a baix referenciada.

- Investigador/a: ${data.nombreApellidosValidador}
- Responsable del contracte titulat: ${sgi.getFieldValue(data.tituloProyecto)}
