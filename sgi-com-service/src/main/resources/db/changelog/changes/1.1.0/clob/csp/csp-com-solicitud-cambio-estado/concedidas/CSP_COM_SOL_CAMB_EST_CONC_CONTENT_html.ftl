...
<p>Us informem que s'ha publicat la resolució de concessió de la convocatòria baix referenciada en què la vostra sol·licitud apareix concedida.</p>
<p>
...
<#if data.enlaces?has_content>
<p>Podeu consultar la informació disponible als enllaços següents:</p>
<ul>
<#list data.enlaces as enlace>
<li>
  <#if enlace.tipoEnlace?has_content && enlace.descripcion?has_content && enlace.url?has_content >
