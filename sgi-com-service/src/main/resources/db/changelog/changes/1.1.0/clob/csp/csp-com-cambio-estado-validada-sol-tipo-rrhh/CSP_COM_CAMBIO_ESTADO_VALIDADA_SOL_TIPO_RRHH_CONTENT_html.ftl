...
<p>Us informem que la vostra sol·licitud sota referenciada ha estat validada pel/la tutor/a.</p>
<p>
- Data de la validació: ${sgi.formatDate(data.fechaEstado, "SHORT")}<br>
