...
Le informamos de que se ha publicado la resolución de definitiva de la convocatoria abajo referenciada, en la que su solicitud aparece como denegada.
...
<#setting locale="en">
Dear researcher,
Please be advised that the final decision of the below call has been published, and your application has been rejected.
...
Honen bidez jakinarazten dizugu behean aipatutako deialdiaren behin betiko ebazpena argitaratu dela eta bertan zure eskaera ukatuta ageri dela.
...
Us informem que s'ha publicat la resolució definitiva de la convocatòria sota referenciada, en la qual la vostra sol·licitud apareix com a denegada.
- Data de la resolució: <#if (data.fechaConcesionConvocatoria)?has_content>${sgi.formatDate(data.fechaConcesionConvocatoria, "SHORT")}<#else>-</#if>
- Convocatòria: ${sgi.getFieldValue(data.tituloConvocatoria)}

<#if data.enlaces?has_content>
Podeu consultar la informació disponible en els enllaços següents:
