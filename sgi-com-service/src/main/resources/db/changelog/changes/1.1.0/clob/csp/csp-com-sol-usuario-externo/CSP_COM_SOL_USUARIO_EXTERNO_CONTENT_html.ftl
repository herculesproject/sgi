...
<p>Us informem que la vostra sol·licitud associada a la convocatòria baix referenciada ha estat creada en estat "esborrany".</p>
<p>- Convocatòria: ${sgi.getFieldValue(data.tituloConvocatoria)}</p>
<p>Podeu consultar l'estat de la mateixa des de l'aplicació, mitjançant les següents instruccions:</p>
<p>
- Enllaç d'accés: <a href="${data.enlaceAplicacion}" target="_blank"><b>${data.enlaceAplicacion}</b></a><br>
- Identificació: el vostre número de document d'identificació personal<br>
- Codi de referència: ${data.uuid}
</p>
