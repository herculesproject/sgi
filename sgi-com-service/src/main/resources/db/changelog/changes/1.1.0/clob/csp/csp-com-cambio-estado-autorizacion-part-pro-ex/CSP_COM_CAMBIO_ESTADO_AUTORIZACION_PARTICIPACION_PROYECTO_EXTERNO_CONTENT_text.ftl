...
Us informem que s'ha modificat la vostra sol·licitud d'autorització de participació en el projecte:

- Data de modificació: ${sgi.formatDate(data.fechaEstadoSolicitudPext, "SHORT")}
