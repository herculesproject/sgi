...
Us informem que s'ha aconseguit la següent fita de la convocatòria referenciada:

- Fita: <#if CSP_HITO_TIPO?has_content && CSP_HITO_TIPO != "[]">${sgi.getFieldValue(CSP_HITO_TIPO)}<#else>-</#if>
