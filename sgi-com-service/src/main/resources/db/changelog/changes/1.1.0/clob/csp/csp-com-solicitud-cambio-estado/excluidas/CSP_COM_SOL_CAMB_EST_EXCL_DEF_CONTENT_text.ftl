...
Us informem que s'ha publicat la Resolució d'Admesos i Exclosos, amb caràcter definitiu, de la convocatòria sota referenciada, en la qual la vostra sol·licitud apareix exclosa:
...
<#if data.enlaces?has_content>
Podeu consultar la informació disponible als següents enllaços:
