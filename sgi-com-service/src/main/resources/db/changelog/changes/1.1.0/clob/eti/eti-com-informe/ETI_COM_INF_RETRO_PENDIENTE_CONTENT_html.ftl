...
<#macro renderCa>
<#setting locale="ca">
<p>Recordatori de sol·licitud d'avaluació retrospectiva</p>
<p>Benvolgut/da investigador/a,</p>
<p>Us recordem que, tal com es reflecteix a l'autorització de l'òrgan autonòmic corresponent, per a la realització del projecte esmentat més avall, caldrà que realitzeu la corresponent avaluació retrospectiva, a través del formulari que podeu trobar al web: <a href="${data.enlaceAplicacion}" target="_blank"><b>${data.enlaceAplicacion}</b></a>.</p>
<p>
