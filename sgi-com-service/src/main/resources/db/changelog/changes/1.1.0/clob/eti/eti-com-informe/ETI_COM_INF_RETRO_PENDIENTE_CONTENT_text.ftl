...
<#macro renderCa>
<#setting locale="ca">
Recordatori de sol·licitud d'avaluació retrospectiva

Benvolgut/da investigador/a,

Us recordem que, tal com es reflecteix a l'autorització de l'òrgan autonòmic corresponent, per a la realització del projecte esmentat més avall, caldrà que realitzeu la corresponent avaluació retrospectiva, a través del formulari: ${data.enlaceAplicacion}.
