...
<p>Le informamos de que se ha publicado la resolución de definitiva de la convocatoria abajo referenciada, en la que su solicitud aparece como denegada.</p>
<p>
...
<#setting locale="en">
<p>Dear researcher,</p>
<p>Please be advised that the final decision of the below call has been published, and your application has been rejected.</p>
<p>
...
<p>Honen bidez jakinarazten dizugu behean aipatutako deialdiaren behin betiko ebazpena argitaratu dela eta bertan zure eskaera ukatuta ageri dela.</p>
<p>
...
<p>Us informem que s'ha publicat la resolució definitiva de la convocatòria sota referenciada, en la qual la vostra sol·licitud apareix com a denegada.</p>
<p>
...
<#if data.enlaces?has_content>
<p>Podeu consultar la informació disponible en els enllaços següents:</p>
<ul>
<#list data.enlaces as enlace>
<li>
  <#if enlace.tipoEnlace?has_content && enlace.descripcion?has_content && enlace.url?has_content >
