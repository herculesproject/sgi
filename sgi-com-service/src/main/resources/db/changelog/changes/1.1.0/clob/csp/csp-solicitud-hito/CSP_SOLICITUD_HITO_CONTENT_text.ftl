<#macro renderEs>
<#setting locale="es">
Le informamos de que próximamente se alcanzará un nuevo hito en la solicitud asociada a la convocatoria abajo referenciada:
...
Us informem que properament s'assolirà una nova fita en la sol·licitud associada a la convocatòria baix referenciada:
...
- Sol·licitud: <#if CSP_SOLICITUD_TITULO?has_content && CSP_SOLICITUD_TITULO != "[]">${sgi.getFieldValue(CSP_SOLICITUD_TITULO)}<#else>-</#if>
