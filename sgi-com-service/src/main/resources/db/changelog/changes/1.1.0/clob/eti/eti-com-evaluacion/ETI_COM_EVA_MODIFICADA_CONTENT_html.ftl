...
<#macro renderCa>
<#setting locale="ca">
<p>Benvolgut/da membre del Comitè:</p>
<p>Us informem que la persona responsable de la memòria ha realitzat les modificacions sol·licitades. Podeu procedir a la seva revisió:</p>
<p>
- Títol de la memòria: ${sgi.getFieldValue(data.tituloSolicitudEvaluacion)}<br>
