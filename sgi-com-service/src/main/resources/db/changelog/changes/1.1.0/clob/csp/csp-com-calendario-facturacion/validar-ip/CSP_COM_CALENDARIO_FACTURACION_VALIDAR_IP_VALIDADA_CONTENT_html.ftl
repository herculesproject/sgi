...
<#macro renderCa>
<#setting locale="ca">
<p>Us informem que teniu el vistiplau per a l'emissió de la factura a baix referenciada.</p>
<p>
- Investigador/a: ${data.nombreApellidosValidador}<br>
- Responsable del contracte titulat: ${sgi.getFieldValue(data.tituloProyecto)}<br>
- Associat als projectes amb codi/s: ${data.codigosSge?join(", ")}<br>
- Vistiplau per a l'emissió de la factura número: ${data.numPrevision}
</p>
<p>
