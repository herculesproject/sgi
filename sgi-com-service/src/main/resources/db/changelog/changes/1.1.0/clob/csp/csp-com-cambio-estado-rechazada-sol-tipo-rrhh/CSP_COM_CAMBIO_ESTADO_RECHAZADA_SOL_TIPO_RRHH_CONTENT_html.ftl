...
<p>Us informem que la vostra sol·licitud a baix referenciada ha estat rebutjada pel/per la tutor/a.</p>
<p>
- Data del rebuig: ${sgi.formatDate(data.fechaEstado, "SHORT")}<br>
- Sol·licitud: ${data.codigoInternoSolicitud}<br>
