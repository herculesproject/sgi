...
<#macro renderCa>
<#setting locale="ca">
<p>Estimat/da investigador/a,</p>
<p>
Un cop signat el contracte baix referenciat, s'ha d'emetre la factura corresponent. Per això necessitem que ens confirmi que els treballs han finalitzat.
</p>
<p>
- Contracte amb la/les empresa/es: ${data.entidadesFinanciadoras?join(", ")}<br>
- Títol:${sgi.getFieldValue(data.tituloProyecto)}<br>
