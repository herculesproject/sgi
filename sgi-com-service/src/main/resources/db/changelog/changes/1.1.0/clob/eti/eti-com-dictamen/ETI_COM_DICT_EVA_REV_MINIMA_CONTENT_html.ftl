...
<p>Un cop avaluada la vostra sol·licitud, us informem que ja podeu descarregar l'informe corresponent a l'aplicació: <a href="${data.enlaceAplicacion}" target="_blank"><b>${data.enlaceAplicacion}</b></a>.</p>
<p>
