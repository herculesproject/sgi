...
<p>Us informem que s'ha modificat la vostra sol·licitud d'autorització de participació en el projecte:</p>
<p>
- Data de modificació: ${sgi.formatDate(data.fechaEstadoSolicitudPext, "SHORT")}<br>
- Projecte: ${sgi.getFieldValue(data.tituloPext)}<br>
