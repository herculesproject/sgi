...
Us informem que s'ha publicat la resolució de concessió de la convocatòria baix referenciada en què la vostra sol·licitud apareix concedida.
...
<#if data.enlaces?has_content>
Podeu consultar la informació disponible als enllaços següents:
