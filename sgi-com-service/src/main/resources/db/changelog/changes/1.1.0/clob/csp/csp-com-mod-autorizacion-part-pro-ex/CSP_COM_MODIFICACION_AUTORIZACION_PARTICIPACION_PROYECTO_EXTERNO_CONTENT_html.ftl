...
<p>Us informem que ha estat registrada la sol·licitud d'autorització de participació en el projecte extern sota indicat:</p>
<p>
- Data de la sol·licitud: ${sgi.formatDate(data.fecha, "SHORT")}<br>
- Projecte extern: ${sgi.getFieldValue(data.tituloProyecto)}<br>
- Persona sol·licitant: ${data.nombreSolicitante}
</p>
