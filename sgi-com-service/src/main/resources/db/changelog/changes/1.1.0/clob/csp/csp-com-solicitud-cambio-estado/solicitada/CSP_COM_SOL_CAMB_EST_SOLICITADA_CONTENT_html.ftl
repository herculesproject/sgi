...
<p>Us informem que ha estat registrada correctament la sol·licitud referida a continuació:</p>
<p>
...
- Sol·licitud presentada per: ${data.nombreApellidosSolicitante}<br>
