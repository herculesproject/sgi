...
Us informem que s'ha registrat una sol·licitud, indicant que vostè participarà com a tutor/a del treball associat.

- Data de sol·licitud: ${sgi.formatDate(data.fechaEstado, "SHORT")}
- Persona que registra la sol·licitud: ${data.nombreApellidosSolicitante}
- Sol·licitud registrada: ${data.codigoInternoSolicitud}
