...
Us informem que disposeu d'un nou ítem que necessita la vostra validació per poder realitzar la vostra baremació:

- Tipus d'ítem: ${sgi.getFieldValue(data.nombreEpigrafe)}
- Títol/nom: ${data.tituloItem}
- Data: ${sgi.formatDate(data.fechaItem, "SHORT")}
