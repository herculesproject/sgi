...
<p>Us recordem que un cop ha passat un any des de la data d'obtenció de l'informe favorable de l'activitat esmentada més avall, caldrà que realitzeu l'informe de seguiment anual corresponent, a través de l'aplicació <a href="${data.enlaceAplicacion}" target="_blank"><b>${data.enlaceAplicacion}</b></a>.</p>
<p>
