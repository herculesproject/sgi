...
Us informem que en la propera convocatòria de reunió s'avaluarà la memòria referenciada:

- Data de la reunió de la comissió: ${sgi.formatDate(data.fechaConvocatoriaReunion, "SHORT")}
- Memòria a avaluar: ${data.referenciaMemoria}
- Projecte: ${sgi.getFieldValue(data.tituloSolicitudEvaluacion)}

El parell avaluador assignat és el següent:
${data.nombreApellidosEvaluador1}
${data.nombreApellidosEvaluador2}
