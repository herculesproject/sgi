...
<#macro renderCa>
<#setting locale="ca">
Benvolgut/da membre del ${data.nombreComite},

Us informem que teniu a la vostra disposició l'acta de la reunió celebrada el ${sgi.formatDate(data.fechaEvaluacion, "FULL")}
