...
Us informem que ha estat registrada la sol·licitud d'autorització de participació en el projecte extern sota indicat:

- Data de la sol·licitud: ${sgi.formatDate(data.fecha, "SHORT")}
- Projecte extern: ${sgi.getFieldValue(data.tituloProyecto)}
