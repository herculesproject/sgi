...
Revisada la sol·licitud sota indicada, 

- Tipus de sol·licitud: ${sgi.getFieldValue(data.tipoActividad)}
- Títol: ${sgi.getFieldValue(data.tituloSolicitudEvaluacion)}
- Referència CEID: ${data.referenciaMemoria}

Us informem que heu de realitzar les següents modificacions/aclariments a través de l'aplicació ${data.enlaceAplicacion}.
