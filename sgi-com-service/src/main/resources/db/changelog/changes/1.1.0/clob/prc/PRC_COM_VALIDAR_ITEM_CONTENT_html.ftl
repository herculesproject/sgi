...
<p>Us informem que disposeu d'un nou ítem que necessita la vostra validació per poder realitzar la vostra baremació:</p>
<p>
- Tipus d'ítem: ${sgi.getFieldValue(data.nombreEpigrafe)}<br>
- Títol/nom: ${data.tituloItem}<br>
- Data: ${sgi.formatDate(data.fechaItem, "SHORT")}
</p>
<p>
