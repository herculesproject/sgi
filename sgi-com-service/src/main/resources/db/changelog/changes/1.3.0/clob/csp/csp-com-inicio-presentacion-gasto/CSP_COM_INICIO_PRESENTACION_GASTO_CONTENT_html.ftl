...
<p>
- Proyecto: ${sgi.getFieldValue(proyecto.titulo)?no_esc}<br>
...
<#list data.proyectos as proyecto>
<p>
- Project: ${sgi.getFieldValue(proyecto.titulo)?no_esc}<br>
...
<#list data.proyectos as proyecto>
<p>
- Proiektua: ${sgi.getFieldValue(proyecto.titulo)?no_esc}<br>
...
<p>Us informem que properament s'inicien els períodes de presentació de la justificació per al seguiment científic dels projectes sota indicats.</p>
<p>Els períodes de presentació de la documentació de justificació són els següents:</p>
<#list data.proyectos as proyecto>
<p>
- Projecte: ${sgi.getFieldValue(proyecto.titulo)?no_esc}<br>
- Inici del període de presentació de justificació: ${sgi.formatDate(proyecto.fechaInicio, "SHORT")}, ${sgi.formatTime(proyecto.fechaInicio, "SHORT")}<br>
