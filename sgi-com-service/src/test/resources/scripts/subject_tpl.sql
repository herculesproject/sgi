INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(1, 'master', '2022-08-04 10:29:22.944', 'master', '2022-08-04 10:29:22.944', 'Plantilla de asunto genérico', 'GENERIC_SUBJECT', '${GENERIC_SUBJECT}', '${GENERIC_SUBJECT}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(2, NULL, NULL, NULL, NULL, 'Plantilla de asunto para Convocatorias-Hitos', 'CSP_CONVOCATORIA_HITO_SUBJECT', 'Hito "${CSP_HITO_TIPO}" de la convocatoria "${CSP_CONVOCATORIA_TITULO}"', 'Hito "${CSP_HITO_TIPO}" de la convocatoria "${CSP_CONVOCATORIA_TITULO}"');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(3, 'master', '2022-08-04 10:29:22.944', 'master', '2022-08-04 10:29:22.944', 'Asunto del aviso de inicio del período de presentación de justificación de gastos', 'CSP_COM_INICIO_PRESENTACION_GASTO_SUBJECT', '<#assign data = CSP_COM_INICIO_PRESENTACION_GASTO_DATA?eval />
<#--
...
-->
Inicio de período de presentación de justificación de gastos de ${data.fecha?date.iso?string.MMMM} de ${data.fecha?date.iso?string.yyyy}', '<#assign data = CSP_COM_INICIO_PRESENTACION_GASTO_DATA?eval />
<#--
  Formato CSP_COM_INICIO_PRESENTACION_GASTO_DATA:
  { 
    "fecha": "2022-01-01",
...
-->
Vencimiento cercano de período de presentación de justificación del proyecto ${data.titulo}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(8, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el alta de solicitud de petición evaluación de ética', 'CSP_COM_SOLICITUD_PETICION_EVALUACION_SUBJECT', 'Solicitud de evaluación de ética "${ETI_PETICION_EVALUACION_CODIGO}"','Solicitud de evaluación de ética "${ETI_PETICION_EVALUACION_CODIGO}"');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(9, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el cambio de estado de solicitud a solicitada', 'CSP_COM_SOL_CAMB_EST_SOLICITADA_SUBJECT', '<#assign data = CSP_COM_SOL_CAMB_EST_SOLICITADA_DATA?eval_json />
Registrada solicitud a la convocatoria de ${data.tituloConvocatoria}', '<#assign data = CSP_COM_SOL_CAMB_EST_SOLICITADA_DATA?eval_json /> Registrada solicitud a la convocatoria de ${data.tituloConvocatoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(10, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el cambio de estado de solicitud a alegaciones', 'CSP_COM_SOL_CAMB_EST_ALEGACIONES_SUBJECT', '<#assign data = CSP_COM_SOL_CAMB_EST_ALEGACIONES_DATA?eval_json />
Presentadas alegaciones a la convocatoria de ${data.tituloConvocatoria}', '<#assign data = CSP_COM_SOL_CAMB_EST_ALEGACIONES_DATA?eval_json /> Presentadas alegaciones a la convocatoria de ${data.tituloConvocatoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(11, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el cambio de estado de solicitud a excluida provisional', 'CSP_COM_SOL_CAMB_EST_EXCL_PROV_SUBJECT', '<#assign data = CSP_COM_SOL_CAMB_EST_EXCL_PROV_DATA?eval_json />
Solicitud excluida con carácter provisional en la convocatoria de ${data.tituloConvocatoria} ','<#assign data = CSP_COM_SOL_CAMB_EST_EXCL_PROV_DATA?eval_json /> Solicitud excluida con carácter provisional en la convocatoria de ${data.tituloConvocatoria} ');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(12, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el cambio de estado de solicitud excluida definitiva', 'CSP_COM_SOL_CAMB_EST_EXCL_DEF_SUBJECT', '<#assign data = CSP_COM_SOL_CAMB_EST_EXCL_DEF_DATA?eval_json />
Solicitud excluida con carácter definitivo en la convocatoria de ${data.tituloConvocatoria} ', '<#assign data = CSP_COM_SOL_CAMB_EST_EXCL_DEF_DATA?eval_json /> Solicitud excluida con carácter definitivo en la convocatoria de ${data.tituloConvocatoria} ');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(13, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el cambio de estado de solicitud concedida provisional', 'CSP_COM_SOL_CAMB_EST_CONC_PROV_SUBJECT', '<#assign data = CSP_COM_SOL_CAMB_EST_CONC_PROV_DATA?eval_json />
Solicitud concecida con carácter provisional en la convocatoria de ${data.tituloConvocatoria}', '<#assign data = CSP_COM_SOL_CAMB_EST_CONC_PROV_DATA?eval_json /> Solicitud concecida con carácter provisional en la convocatoria de ${data.tituloConvocatoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(14, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el cambio de estado de solicitud a concedida', 'CSP_COM_SOL_CAMB_EST_CONC_SUBJECT', '<#assign data = CSP_COM_SOL_CAMB_EST_CONC_DATA?eval_json />
Solicitud concedida con carácter definitivo en la convocatoria de ${data.tituloConvocatoria}', '<#assign data = CSP_COM_SOL_CAMB_EST_CONC_DATA?eval_json /> Solicitud concedida con carácter definitivo en la convocatoria de ${data.tituloConvocatoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(15, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el cambio de estado de solicitud denegada provisional', 'CSP_COM_SOL_CAMB_EST_DEN_PROV_SUBJECT', '<#assign data = CSP_COM_SOL_CAMB_EST_DEN_PROV_DATA?eval_json />
Solicitud denegada con carácter provisional en la convocatoria de ${data.tituloConvocatoria}', '<#assign data = CSP_COM_SOL_CAMB_EST_DEN_PROV_DATA?eval_json /> Solicitud denegada con carácter provisional en la convocatoria de ${data.tituloConvocatoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(16, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el cambio de estado de solicitud denegada', 'CSP_COM_SOL_CAMB_EST_DEN_SUBJECT', '<#assign data = CSP_COM_SOL_CAMB_EST_DEN_DATA?eval_json />
Solicitud denegada con carácter definitivo en la convocatoria de ${data.tituloConvocatoria}', '<#assign data = CSP_COM_SOL_CAMB_EST_DEN_DATA?eval_json /> Solicitud denegada con carácter definitivo en la convocatoria de ${data.tituloConvocatoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(17, NULL, NULL, NULL, NULL, 'Plantilla de asunto para Solicitudes-Hitos', 'CSP_SOLICITUD_HITO_SUBJECT', 'Hito "${CSP_HITO_TIPO}" de la solicitud "${CSP_SOLICITUD_TITULO}" de la convocatoria "${CSP_CONVOCATORIA_TITULO}"', 'Hito "${CSP_HITO_TIPO}" de la solicitud "${CSP_SOLICITUD_TITULO}" de la convocatoria "${CSP_CONVOCATORIA_TITULO}"');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(18, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de la convocatoria de reunión de ética', 'ETI_COM_CONVOCATORIA_REUNION_SUBJECT', 'Convocatoria de reunión ${ETI_COMITE_NOMBRE_INVESTIGACION}', 'Convocatoria de reunión ${ETI_COMITE_NOMBRE_INVESTIGACION}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(19, 'master', '2022-08-04 10:29:23.440', 'master', '2022-08-04 10:29:23.440', 'Asunto del aviso del vencimiento del período de pago al socio', 'CSP_COM_VENCIMIENTO_PERIODO_PAGO_SOCIO_SUBJECT', '<#assign data = CSP_COM_VENCIMIENTO_PERIODO_PAGO_SOCIO_DATA?eval />
<#--
...
-->
Solicitud de conformidad previa a la emisión de factura con N.º de previsión ${data.numPrevision} y asociado al/los proyectos con código/s SGE <#list data.codigosSge as codigo>${codigo}<#sep>, </#list>');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(31, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de finalizacion de actas de ética', 'ETI_COM_ACTA_SIN_REV_MINIMA_SUBJECT', '<#assign data = ETI_COM_ACTA_SIN_REV_MINIMA_DATA?eval_json />
Informe ${data.nombreInvestigacion} ${data.referenciaMemoria}', '<#assign data = ETI_COM_ACTA_SIN_REV_MINIMA_DATA?eval_json /> Informe ${data.nombreInvestigacion} ${data.referenciaMemoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(32, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de finalizacion de actas de ética con revisión mínima', 'ETI_COM_DICT_EVA_REV_MINIMA_SUBJECT', '<#assign data = ETI_COM_DICT_EVA_REV_MINIMA_DATA?eval_json />
Informe ${data.nombreInvestigacion} ${data.referenciaMemoria}', '<#assign data = ETI_COM_DICT_EVA_REV_MINIMA_DATA?eval_json /> Informe ${data.nombreInvestigacion} ${data.referenciaMemoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(33, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de evaluación de seguimiento con revisión mínima', 'ETI_COM_DICT_EVA_SEG_REV_MINIMA_SUBJECT', '<#assign data = ETI_COM_DICT_EVA_SEG_REV_MINIMA_DATA?eval_json />
Informe ${data.nombreInvestigacion} ${data.referenciaMemoria}', '<#assign data = ETI_COM_DICT_EVA_SEG_REV_MINIMA_DATA?eval_json /> Informe ${data.nombreInvestigacion} ${data.referenciaMemoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(34, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de aviso de evaluación retrospectiva pendiente', 'ETI_COM_INF_RETRO_PENDIENTE_SUBJECT', '<#assign data = ETI_COM_INF_RETRO_PENDIENTE_DATA?eval_json />
Informe evaluación retrospectiva ${data.nombreInvestigacion} ${data.referenciaMemoria}', '<#assign data = ETI_COM_INF_RETRO_PENDIENTE_DATA?eval_json /> Informe evaluación retrospectiva ${data.nombreInvestigacion} ${data.referenciaMemoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(35, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de aviso de evaluación modificada', 'ETI_COM_EVA_MODIFICADA_SUBJECT', '<#assign data = ETI_COM_EVA_MODIFICADA_DATA?eval_json />
Modificaciones mínimas ${data.nombreInvestigacion} ${data.referenciaMemoria} pendiente de revisión', '<#assign data = ETI_COM_EVA_MODIFICADA_DATA?eval_json /> Modificaciones mínimas ${data.nombreInvestigacion} ${data.referenciaMemoria} pendiente de revisión');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(36, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de aviso vencimiento Fin Fecha Prioridad Solicitud de Protección', 'PII_COM_MESES_HASTA_FIN_PRIORIDAD_SOLICITUD_PROTECCION_SUBJECT', '<#assign data = PII_COM_MESES_HASTA_FIN_PRIORIDAD_SOLICITUD_PROTECCION_DATA?eval />
<#--
...
-->
Próximo vencimiento de Plazo de Entrada en fases nacionales/regionales');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(38, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de seguimiento anual pendiente', 'ETI_COM_INF_SEG_ANU_SUBJECT', '<#assign data = ETI_COM_INF_SEG_ANU_DATA?eval_json />
Informe Seguimiento Anual ${data.nombreInvestigacion} ${data.referenciaMemoria}', '<#assign data = ETI_COM_INF_SEG_ANU_DATA?eval_json /> Informe Seguimiento Anual ${data.nombreInvestigacion} ${data.referenciaMemoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(39, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de Cambio de visibilidad del certificado de autorización para la participación en un proyecto externo', 'CSP_COM_ADD_MODIFICAR_CERTIFICADO_AUTORIZACION_PARTICIPACION_PROYECTO_EXTERNO_SUBJECT', '<#assign data = CSP_COM_ADD_MODIFICAR_CERTIFICADO_AUTORIZACION_PARTICIPACION_PROYECTO_EXTERNO_DATA?eval_json />
Disponible autorización de participación en proyecto externo', '<#assign data = CSP_COM_ADD_MODIFICAR_CERTIFICADO_AUTORIZACION_PARTICIPACION_PROYECTO_EXTERNO_DATA?eval_json /> Disponible autorización de participación en proyecto externo');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(40, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de Cambio de estado de la autorización para la participación en un proyecto externo', 'CSP_COM_CAMBIO_ESTADO_AUTORIZACION_PARTICIPACION_PROYECTO_EXTERNO_SUBJECT', '<#assign data = CSP_COM_CAMBIO_ESTADO_AUTORIZACION_PARTICIPACION_PROYECTO_EXTERNO_DATA?eval_json />
Solicitud de autorización de participación en proyecto externo: ${data.estadoSolicitudPext}', '<#assign data = CSP_COM_CAMBIO_ESTADO_AUTORIZACION_PARTICIPACION_PROYECTO_EXTERNO_DATA?eval_json /> Solicitud de autorización de participación en proyecto externo: ${data.estadoSolicitudPext}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(41, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de Cambio de estado a SOLICITADA de una solicitud de RRHH', 'CSP_COM_CAMBIO_ESTADO_SOLICITADA_SOL_TIPO_RRHH_SUBJECT', '<#assign data = CSP_COM_CAMBIO_ESTADO_SOLICITADA_SOL_TIPO_RRHH_DATA?eval_json />
Solicitada tutoría de trabajo <#if data.tituloConvocatoria?has_content>asociado a la convocatoria de ${data.tituloConvocatoria}</#if>', '<#assign data = CSP_COM_CAMBIO_ESTADO_SOLICITADA_SOL_TIPO_RRHH_DATA?eval_json /> Solicitada tutoría de trabajo <#if data.tituloConvocatoria?has_content>asociado a la convocatoria de ${data.tituloConvocatoria}</#if>');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(42, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de Modificación de la autorización para la participación en un proyecto externo', 'CSP_COM_MODIFICACION_AUTORIZACION_PARTICIPACION_PROYECTO_EXTERNO_SUBJECT', '<#assign data = CSP_COM_MODIFICACION_AUTORIZACION_PARTICIPACION_PROYECTO_EXTERNO_DATA?eval_json />
Solicitud de autorización de participación en proyecto externo', '<#assign data = CSP_COM_MODIFICACION_AUTORIZACION_PARTICIPACION_PROYECTO_EXTERNO_DATA?eval_json /> Solicitud de autorización de participación en proyecto externo');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(43, NULL, NULL, NULL, NULL, 'Plantilla de asunto para Proyectos-Hitos', 'CSP_PROYECTO_HITO_SUBJECT', 'Hito ${CSP_HITO_TIPO} del proyecto ${CSP_PROYECTO_TITULO}<#if CSP_CONVOCATORIA_TITULO?has_content> de la convocatoria ${CSP_CONVOCATORIA_TITULO}</#if>', 'Hito ${CSP_HITO_TIPO} del proyecto ${CSP_PROYECTO_TITULO}<#if CSP_CONVOCATORIA_TITULO?has_content> de la convocatoria ${CSP_CONVOCATORIA_TITULO}</#if>');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(44, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de recepcion de notificación de la creación de en un proyecto externo', 'CSP_COM_RECEPCION_NOTIFICACION_CVN_PROYECTO_EXTERNO_SUBJECT', '<#assign data = CSP_COM_RECEPCION_NOTIFICACION_CVN_PROYECTO_EXTERNO_DATA?eval_json />
Nuevo proyecto registrado en CVN', '<#assign data = CSP_COM_RECEPCION_NOTIFICACION_CVN_PROYECTO_EXTERNO_DATA?eval_json /> Nuevo proyecto registrado en CVN');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(45, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de seguimiento final pendiente', 'ETI_COM_INF_SEG_FIN_SUBJECT', '<#assign data = ETI_COM_INF_SEG_FIN_DATA?eval_json />
Informe Seguimiento Final ${data.nombreInvestigacion} ${data.referenciaMemoria}', '<#assign data = ETI_COM_INF_SEG_FIN_DATA?eval_json /> Informe Seguimiento Final ${data.nombreInvestigacion} ${data.referenciaMemoria}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(46, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de Memoria con dictamen Revisión Mínima archivada automáticamente', 'ETI_COM_DICT_MEM_REV_MINIMA_ARCH_SUBJECT', '<#assign data = ETI_COM_DICT_MEM_REV_MINIMA_ARCH_DATA?eval_json />
Solicitud al/a la ${data.nombreInvestigacion} ${data.referenciaMemoria} archivada', '<#assign data = ETI_COM_DICT_MEM_REV_MINIMA_ARCH_DATA?eval_json /> Solicitud al/a la ${data.nombreInvestigacion} ${data.referenciaMemoria} archivada');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(47, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de error en el proceso de baremacion', 'PRC_COM_PROCESO_BAREMACION_ERROR_SUBJECT', '<#assign data = PRC_COM_PROCESO_BAREMACION_ERROR_DATA?eval />
<#--
...
-->
Finalizado proceso de baremación del año ${data.anio}');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(49, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío del comunicado para validar item', 'PRC_COM_VALIDAR_ITEM_SUBJECT', '<#assign data = PRC_COM_VALIDAR_ITEM_DATA?eval />
<#--
...
-->
Nuevo item de tipo ${data.nombreEpigrafe} disponible para su validación.');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(50, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de memorias archivadas por inactividad', 'ETI_COM_MEM_ARCHIVADA_AUT_SUBJECT', '<#assign data = ETI_COM_MEM_ARCHIVADA_AUT_DATA?eval_json />
Solicitud al / a la ${data.nombreInvestigacion} ${data.referenciaMemoria} archivada', '<#assign data = ETI_COM_MEM_ARCHIVADA_AUT_DATA?eval_json /> Solicitud al / a la ${data.nombreInvestigacion} ${data.referenciaMemoria} archivada');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(51, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de fecha límite de procedimiento', 'PII_COM_FECHA_LIMITE_PROCEDIMIENTO_SUBJECT', '<#assign data = PII_COM_FECHA_LIMITE_PROCEDIMIENTO_DATA?eval_json />
Próximo fecha límite para un procedimiento', '<#assign data = PII_COM_FECHA_LIMITE_PROCEDIMIENTO_DATA?eval_json /> Próximo fecha límite para un procedimiento');
INSERT INTO test.subject_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl, default_tpl) VALUES(55, NULL, NULL, NULL, NULL, 'Plantilla de asunto para el envío de comunicados de Cambio de estado a RECHAZADA de una solicitud de RRHH', 'CSP_COM_CAMBIO_ESTADO_RECHAZADA_SOL_TIPO_RRHH_SUBJECT', '<#assign data = PII_COM_FECHA_LIMITE_PROCEDIMIENTO_DATA?eval_json />
Próximo fecha límite para un procedimiento', '<#assign data = PII_COM_FECHA_LIMITE_PROCEDIMIENTO_DATA?eval_json /> Próximo fecha límite para un procedimiento');
