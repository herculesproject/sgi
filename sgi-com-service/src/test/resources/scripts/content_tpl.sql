INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(1, 'master', '2022-08-04 10:29:23.038', 'master', '2022-08-04 10:29:23.038', 'Plantilla de contenido genérico (texto + HTML)', 'GENERIC_CONTENT', '<!DOCTYPE html>
<html>
  <head>
...
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(2, 'master', '2022-08-04 10:29:23.038', 'master', '2022-08-04 10:29:23.038', 'Plantilla de contenido genérico (solo texto)', 'GENERIC_CONTENT_TEXT', NULL, '${GENERIC_CONTENT_TEXT}', '<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  </head>
...
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(8, 'master', '2022-08-04 10:29:23.751', 'master', '2022-08-04 10:29:23.751', 'Contenido del aviso de finalización del período de presentación de justificación de gastos (texto + HTML) para ips', 'CSP_COM_FIN_PRESENTACION_SEGUIMIENTO_CIENTIFICO_IP_CONTENT', '<#assign data = CSP_COM_FIN_PRESENTACION_SEGUIMIENTO_CIENTIFICO_IP_DATA?eval />
<#--
...
Área de Investigación');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(4, 'master', '2022-08-04 10:29:23.038', 'master', '2022-08-04 10:29:23.038', 'Contenido del aviso de inicio del período de presentación de justificación de gastos (texto + HTML)', 'CSP_COM_INICIO_PRESENTACION_GASTO_CONTENT', '<#assign data = CSP_COM_INICIO_PRESENTACION_GASTO_DATA?eval />
<#--
...
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(9, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el alta de solicitud de petición de evaluación de ética', 'CSP_COM_SOLICITUD_PETICION_EVALUACION_CONTENT', '<#ftl output_format="HTML" auto_esc=false>
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
le informamos de que es necesario someter su investigación ante la Comisión de Ética, por lo que se ha creado una solicitud de petición de evaluación con el código "${ETI_PETICION_EVALUACION_CODIGO}" asociada a la solicitud de convocatoria "${CSP_SOLICITUD_CODIGO}".');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(5, 'master', '2022-08-04 10:29:23.038', 'master', '2022-08-04 10:29:23.038', 'Content of the notice of the start of the period for submitting justification of expenses (text + HTML) ', 'CSP_COM_INICIO_PRESENTACION_GASTO_CONTENT_en', '<#assign data = CSP_COM_INICIO_PRESENTACION_GASTO_DATA?eval />
<#--
  Formato CSP_COM_INICIO_PRESENTACION_GASTO_DATA:
  { 
    "fecha": "2022-01-01",
...
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(6, 'master', '2022-08-04 10:29:23.751', 'master', '2022-08-04 10:29:23.751', 'Contenido del aviso de inicio del período de presentación de justificación de gastos (texto + HTML)', 'CSP_COM_INICIO_PRESENTACION_SEGUIMIENTO_CIENTIFICO_CONTENT', '<#assign data = CSP_COM_INICIO_PRESENTACION_SEGUIMIENTO_CIENTIFICO_DATA?eval />
<#--
...
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(7, 'master', '2022-08-04 10:29:23.751', 'master', '2022-08-04 10:29:23.751', 'Contenido del aviso de inicio del período de presentación de justificación de gastos (texto + HTML) para IPs', 'CSP_COM_INICIO_PRESENTACION_SEGUIMIENTO_CIENTIFICO_IP_CONTENT', '<#assign data = CSP_COM_INICIO_PRESENTACION_SEGUIMIENTO_CIENTIFICO_IP_DATA?eval />
<#--
...
Con fecha ${data.fechaCambioEstadoSolicitud?datetime.iso?string("dd/MM/yyyy")} ha sido registrada en nuestra base de datos la solicitud presentada por D./D&ntilde;a. ${data.nombreApellidosSolicitante} a la convocatoria de ${data.tituloConvocatoria} <#if data.fechaPublicacionConvocatoria??>de ${data.fechaPublicacionConvocatoria?datetime.iso?string("dd/MM/yyyy")}</#if>.');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(11, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el cambio de estado de solicitud a alegaciones', 'CSP_COM_SOL_CAMB_EST_ALEGACIONES_CONTENT', '<#assign data = CSP_COM_SOL_CAMB_EST_ALEGACIONES_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
${data.nombreApellidosSolicitante} ha registrado en nuestra base de datos, con fecha ${data.fechaCambioEstadoSolicitud?datetime.iso?string("dd/MM/yyyy")}, una alegación a la resolución de la convocatoria ${data.tituloConvocatoria} <#if data.fechaProvisionalConvocatoria??>con fecha provisional ${data.fechaProvisionalConvocatoria?datetime.iso?string("dd/MM/yyyy")}</#if>, en relación a la solicitud ${data.codigoInternoSolicitud}.');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(12, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el cambio de estado de solicitud a excluida provisional', 'CSP_COM_SOL_CAMB_EST_EXCL_PROV_CONTENT', '<#assign data = CSP_COM_SOL_CAMB_EST_EXCL_PROV_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Sección de Recursos Humanos de la Investigación y Plan Propio
Área de Investigación');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(14, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el cambio de estado de solicitud a denegada provisional', 'CSP_COM_SOL_CAMB_EST_DEN_PROV_CONTENT', '<#assign data = CSP_COM_SOL_CAMB_EST_DEN_PROV_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Sección de Recursos Humanos de la Investigación y Plan Propio
Área de Investigación');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(3, NULL, NULL, NULL, NULL, 'Plantilla de contenido para Convocatorias-Hitos', 'CSP_CONVOCATORIA_HITO_CONTENT', '<#ftl output_format="HTML" auto_esc=false>
...
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(18, NULL, NULL, NULL, NULL, 'Plantilla de contenido para Solicitudes-Hitos', 'CSP_SOLICITUD_HITO_CONTENT', '<#ftl output_format="HTML" auto_esc=false>
<#assign date = CSP_HITO_FECHA?datetime.iso>
<!DOCTYPE html>
<html>
  <head>
...
En el hito se han indicado las siguientes observaciones:
${CSP_HITO_OBSERVACIONES}
</#if>', '<#ftl output_format="HTML" auto_esc=false>
<#assign date = CSP_HITO_FECHA?datetime.iso>
<!DOCTYPE html>
<html>
  <head>
...
Por favor, se ruega confirme su asistencia.
Un saludo.');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(20, 'master', '2022-08-04 10:29:23.751', 'master', '2022-08-04 10:29:23.751', 'Contenido del aviso del vencimiento del período de pago al socio colaborador (texto + HTML)', 'CSP_COM_VENCIMIENTO_PERIODO_PAGO_SOCIO_CONTENT', '<#assign data = CSP_COM_VENCIMIENTO_PERIODO_PAGO_SOCIO_DATA?eval />
<#--
...
Con fecha ${data.fechaPrevistaPago?datetime.iso?string.medium} se alcanzará la fecha prevista del pago al socio colaborador de la Universidad ${data.nombreEntidadColaboradora} 
en el proyecto ${data.titulo}  y aún no se ha registrado la fecha de realización de dicho pago.');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(21, 'master', '2022-08-04 10:29:23.751', 'master', '2022-08-04 10:29:23.751', 'Contenido del aviso del inicio del período de entrega de justificación al socio colaborador (texto + HTML)', 'CSP_COM_INICIO_PERIODO_JUSTIFICACION_SOCIO_CONTENT', '<#assign data = CSP_COM_INICIO_PERIODO_JUSTIFICACION_SOCIO_DATA?eval />
<#--
...
proyecto ${data.titulo}, deberá remitir la documentación de justificación asociada al periodo ${data.numPeriodo}.
');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(22, 'master', '2022-08-04 10:29:23.751', 'master', '2022-08-04 10:29:23.751', 'Contenido del aviso del vencimiento del período de entrega de justificación al socio colaborador (texto + HTML)', 'CSP_COM_FIN_PERIODO_JUSTIFICACION_SOCIO_CONTENT', '<#assign data = CSP_COM_FIN_PERIODO_JUSTIFICACION_SOCIO_DATA?eval />
<#--
...
En espera de su respuesta reciba un cordial saludo, OTRI.');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(36, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envío de comunicados de aviso de evaluación modificada', 'ETI_COM_EVA_MODIFICADA_CONTENT', '<#assign data = ETI_COM_EVA_MODIFICADA_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Firma Secretaría ${data.nombreInvestigacion}');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(33, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envio de evaluaciones al finalizar acta con revisión mínima', 'ETI_COM_DICT_EVA_REV_MINIMA_CONTENT', '<#assign data = ETI_COM_DICT_EVA_REV_MINIMA_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Firma Secretaría ${data.nombreInvestigacion}');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(34, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envio de evaluaciones de seguimiento con revisión mínima', 'ETI_COM_DICT_EVA_SEG_REV_MINIMA_CONTENT', '<#assign data = ETI_COM_DICT_EVA_SEG_REV_MINIMA_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
En espera de su respuesta reciba un cordial saludo, OTRI.
');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(15, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el cambio de estado de solicitud a denegada', 'CSP_COM_SOL_CAMB_EST_DEN_CONTENT', '<#assign data = CSP_COM_SOL_CAMB_EST_DEN_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Con fecha ${data.fecha?datetime.iso?string("dd/MM/yyyy")}, ha sido registrada en nuestra base de datos la solicitud de autorización de participación en el proyecto externo ${data.tituloProyecto} por parte de ${data.nombreSolicitante}');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(44, NULL, NULL, NULL, NULL, 'Plantilla de contenido para Proyectos-Hitos', 'CSP_PROYECTO_HITO_CONTENT', '<#ftl output_format="HTML" auto_esc=false>
<#assign date = CSP_HITO_FECHA?datetime.iso>
<!DOCTYPE html>
<html>
  <head>
...
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(13, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el cambio de estado de solicitud a excluida definitiva', 'CSP_COM_SOL_CAMB_EST_EXCL_DEF_CONTENT', '<#assign data = CSP_COM_SOL_CAMB_EST_EXCL_DEF_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Sección de Recursos Humanos de la Investigación y Plan Propio
Área de Investigación');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(16, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el cambio de estado de solicitud a concedida provisional', 'CSP_COM_SOL_CAMB_EST_CONC_PROV_CONTENT', '<#assign data = CSP_COM_SOL_CAMB_EST_CONC_PROV_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Con fecha ${data.fechaCreacion?datetime.iso?string("dd/MM/yyyy")}, ha sido registrada en nuestra base de datos la notificación de creación del proyecto ${data.tituloProyecto} en el CVN de ${data.nombreApellidosCreador}.
');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(46, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envío de comunicados de seguimiento final pendiente', 'ETI_COM_INF_SEG_FIN_CONTENT', '<#assign data = ETI_COM_INF_SEG_FIN_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Firma Secretaría ${data.nombreInvestigacion}');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(17, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el cambio de estado de solicitud a concedida', 'CSP_COM_SOL_CAMB_EST_CONC_CONTENT', '<#assign data = CSP_COM_SOL_CAMB_EST_CONC_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Sección de Recursos Humanos de la Investigación y Plan Propio
Área de Investigación');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(39, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envío de comunicados de seguimiento anual pendiente', 'ETI_COM_INF_SEG_ANU_CONTENT', '<#assign data = ETI_COM_INF_SEG_ANU_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Área de Investigación');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(47, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envio de Memoria con dictamen Revisión Mínima archivada automáticamente', 'ETI_COM_DICT_MEM_REV_MINIMA_ARCH_CONTENT', '<#assign data = ETI_COM_DICT_MEM_REV_MINIMA_ARCH_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Firma Secretaría ${data.nombreInvestigacion}');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(48, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envío de error en el proceso de baremacion', 'PRC_COM_PROCESO_BAREMACION_ERROR_CONTENT', '<#assign data = PRC_COM_PROCESO_BAREMACION_ERROR_DATA?eval />
<#--
...
-->
Se ha producido un error en el proceso de baremación del ${data.anio}. El error producido es ${data.error}.');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(49, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envío de fin del proceso de baremacion', 'PRC_COM_PROCESO_BAREMACION_FIN_CONTENT', '<#assign data = PRC_COM_PROCESO_BAREMACION_FIN_DATA?eval />
<#--
...
-->
El proceso de baremación del <b>${data.anio}</b> ha finalizado con éxito. Puede ir a la opción de menú "Informes" para ver su resultado');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(50, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envío del comunicado para validar item', 'PRC_COM_VALIDAR_ITEM_CONTENT', '<#assign data = PRC_COM_VALIDAR_ITEM_DATA?eval />
<#--
...
le informamos que dispone de un nuevo item de tipo ${data.nombreEpigrafe} con título/nombre ${data.tituloItem} y fecha ${data.fechaItem?datetime.iso?string("dd/MM/yyyy")} que precisa de su validación para poder realizar la baremación sobre él.');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(51, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envío de comunicados de memoria archivada por inactividad', 'ETI_COM_MEM_ARCHIVADA_AUT_CONTENT', '<#assign data = ETI_COM_MEM_ARCHIVADA_AUT_DATA?eval_json />
<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Se informa que el día ${data.fechaLimite?datetime.iso?string("dd/MM/yyyy")} acaba el plazo para solicitar el trámite de ${data.tipoProcedimiento}, para el que se han indicado las siguientes acciones a tomar: ${data.accionATomar}.
');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(37, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envio de avisos de vencimiento de fin de fecha de prioridad de unsa solicitud de protección', 'PII_COM_MESES_HASTA_FIN_PRIORIDAD_SOLICITUD_PROTECCION_CONTENT', '<#assign data = PII_COM_MESES_HASTA_FIN_PRIORIDAD_SOLICITUD_PROTECCION_DATA?eval />
<#--
...
Se informa que queda<#if data.monthsBeforeFechaFinPrioridad != 1>n</#if> ${data.monthsBeforeFechaFinPrioridad} mes<#if data.monthsBeforeFechaFinPrioridad != 1>es</#if> y que, el d&iacute;a ${data.fechaFinPrioridad?datetime.iso?string("dd/MM/yyyy")}, finaliza el plazo de prioridad para la extensión de la invención de referencia, con título ${data.solicitudTitle}.
');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(38, NULL, NULL, NULL, NULL, 'Plantilla de contenido para el envio de avisos de vencimiento del plazo para entrar en las fases nacionales/regionales de una solicitud de protección', 'PII_COM_AVISO_FIN_PLAZO_PRESENTACION_FASES_NACIONALES_REGIONALES_SOLICITUD_PROTECCION_CONTENT', '<#assign data = PII_COM_AVISO_FIN_PLAZO_PRESENTACION_FASES_NACIONALES_REGIONALES_SOLICITUD_PROTECCION_DATA?eval />
<#--
...
Área de Investigación');
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(53, NULL, NULL, NULL, NULL, 'Plantilla de contenido para Convocatorias-Fases', 'CSP_COM_CONVOCATORIA_FASE_CONTENT', '<#ftl output_format="HTML" auto_esc=false>
...
INSERT INTO test.content_tpl (id, created_by, creation_date, last_modified_by, last_modified_date, description, name, tpl_html, tpl_text, default_tpl_html, default_tpl_text) VALUES(54, NULL, NULL, NULL, NULL, 'Plantilla de contenido para Proyecto-Fases', 'CSP_COM_PROYECTO_FASE_CONTENT', '<#ftl output_format="HTML" auto_esc=false>
