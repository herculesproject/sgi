...
import org.crue.hercules.sgi.prc.model.Config_;
import org.crue.hercules.sgi.framework.exception.NotFoundException;
import org.crue.hercules.sgi.framework.test.web.servlet.result.SgiMockMvcResultHandlers;
import org.crue.hercules.sgi.prc.config.SgiConfigProperties;
import org.crue.hercules.sgi.prc.converter.ConfigConverter;
import org.crue.hercules.sgi.prc.dto.CreateConfigInput;
import org.crue.hercules.sgi.prc.model.Config;
import org.crue.hercules.sgi.prc.service.ConfigService;
...
class ConfigControllerTest extends BaseControllerTest {
  ...
  void creteConfig_WithExistingName_ReturnsBadRequest() throws Exception {
    ...
    BDDMockito.given(service.create(ArgumentMatchers.<Config>any())).will(invocation -> {
      ...
      List<ConstraintViolation<Config>> prcList = Arrays.asList(constraintViolation);
      Set<ConstraintViolation<Config>> prcSet = new HashSet<>(prcList);
      throw new ConstraintViolationException(prcSet);
    });
