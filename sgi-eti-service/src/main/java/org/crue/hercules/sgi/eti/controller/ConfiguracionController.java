 ...
 */
@RestController
@RequestMapping(ConstantesEti.CONFIGURACION_CONTROLLER_BASE_PATH)
@Slf4j
public class ConfiguracionController {
   ...
   */
  @PostMapping
  ResponseEntity<Configuracion> newConfiguracion(@Valid @RequestBody Configuracion nuevaConfiguracion) {
