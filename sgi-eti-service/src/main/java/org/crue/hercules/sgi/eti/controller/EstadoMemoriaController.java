 ...
 */
@RestController
@RequestMapping(ConstantesEti.ESTADO_MEMORIA_CONTROLLER_BASE_PATH)
@Slf4j
public class EstadoMemoriaController {
   ...
   */
  @PostMapping
  ResponseEntity<EstadoMemoria> newEstadoMemoria(@Valid @RequestBody EstadoMemoria nuevoEstadoMemoria) {
