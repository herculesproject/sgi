...
import org.crue.hercules.sgi.eti.repository.custom.CustomApartadoRepository;
...
public interface ApartadoRepository
    extends JpaRepository<Apartado, Long>, JpaSpecificationExecutor<Apartado>, CustomApartadoRepository {
  ...
  /**
   * Devuelve una lista paginada de {@link Apartado}
   * 
   * @param idApartado Id de {@link Apartado}.
   * @param idPadre    Id de padre del {@link Apartado}.
   * @return lista de {@link Apartado}
   */
  List<Apartado> findByIdAndPadreId(Long idApartado, Long idPadre);
