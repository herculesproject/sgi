...
INSERT INTO eti.tipo_documento (id, nombre, formulario_id, activo) VALUES (5, 'Documento de cesión de datos', 1, true);
INSERT INTO eti.tipo_documento (id, nombre, formulario_id, activo) VALUES (6, 'Documento de autorización', 1, true);
INSERT INTO eti.tipo_documento (id, nombre, formulario_id, activo) VALUES (7, 'Documento de aceptación de colaboración', 1, true);
...
INSERT INTO eti.documentacion_memoria (id, memoria_id, tipo_documento_id, documento_ref, aportado) VALUES (2, 1, 5, 'doc-002', true);
INSERT INTO eti.documentacion_memoria (id, memoria_id, tipo_documento_id, documento_ref, aportado) VALUES (3, 1, 6, 'doc-003', true);
INSERT INTO eti.documentacion_memoria (id, memoria_id, tipo_documento_id, documento_ref, aportado) VALUES (4, 1, 7, 'doc-004', true);
