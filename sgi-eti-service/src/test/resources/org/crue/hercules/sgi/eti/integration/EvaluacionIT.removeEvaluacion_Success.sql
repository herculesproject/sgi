...
INSERT INTO ETI.ESTADO_RETROSPECTIVA
(ID, NOMBRE, ACTIVO)
VALUES(2, 'EstadoRetrospectiva02', true);
INSERT INTO ETI.ESTADO_RETROSPECTIVA
(ID, NOMBRE, ACTIVO)
VALUES(3, 'En evaluación', true);

-- RETROSPECTIVA
INSERT INTO ETI.RETROSPECTIVA
(ID, ESTADO_RETROSPECTIVA_ID, FECHA_RETROSPECTIVA)
VALUES(1, 3, '2020-07-01');        
...
VALUES(1, 1, '2040-10-01 00:00:00.000', '2020-12-01', 'Lugar 01', 'Orden del día convocatoria reunión 0', 2020, 1, 1, 8, 30, '2020-10-13', true);
...
-- EVALUACION
INSERT INTO eti.evaluacion(id, memoria_id, dictamen_id, convocatoria_reunion_id, tipo_evaluacion_id, es_rev_minima, evaluador1_id, evaluador2_id, version, activo) VALUES(1, 1, null , 1, 1, true, 1, 2, 2, true);
