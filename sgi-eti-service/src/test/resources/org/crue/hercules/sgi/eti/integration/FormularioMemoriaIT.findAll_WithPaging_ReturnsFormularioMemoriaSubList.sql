...
INSERT INTO eti.memoria (id, num_referencia, peticion_evaluacion_id, comite_id, titulo, usuario_ref, tipo_memoria_id, estado_actual_id, fecha_envio_secretaria, requiere_retrospectiva, retrospectiva_id, version, activo)
  VALUES (100, 'ref-5588', 1, 2, 'Memoria1', 'userref-55698', 1, 1, null, false, 1, 1, true);

-- FORMULARIO 
INSERT INTO eti.formulario (id, nombre, descripcion, activo) VALUES (200, 'M10', 'Descripcion', true);

-- FORMULARIO MEMORIA
INSERT INTO eti.formulario_memoria (id, memoria_id, formulario_id, activo)
  VALUES (1, 100, 200, true);
INSERT INTO eti.formulario_memoria (id, memoria_id, formulario_id, activo)
  VALUES (2, 100, 200, true);
INSERT INTO eti.formulario_memoria (id, memoria_id, formulario_id, activo)
  VALUES (3, 100, 200, true);
INSERT INTO eti.formulario_memoria (id, memoria_id, formulario_id, activo)
  VALUES (4, 100, 200, true);
INSERT INTO eti.formulario_memoria (id, memoria_id, formulario_id, activo)
  VALUES (5, 100, 200, true);
INSERT INTO eti.formulario_memoria (id, memoria_id, formulario_id, activo)
  VALUES (6, 100, 200, true);
INSERT INTO eti.formulario_memoria (id, memoria_id, formulario_id, activo)
  VALUES (7, 100, 200, true);
INSERT INTO eti.formulario_memoria (id, memoria_id, formulario_id, activo)
  VALUES (8, 100, 200, true);
