...
VALUES(1, 1, '2020-07-01 00:00:00.000', '2020-08-01', 'Lugar 1', 'Orden del día convocatoria reunión 0', 2020, 1, 1, 8, 30, '2020-07-13', true);
...
-- EVALUACION
INSERT INTO eti.evaluacion(id, memoria_id, dictamen_id, convocatoria_reunion_id, tipo_evaluacion_id, es_rev_minima, fecha_dictamen, version, activo) VALUES(1, 1, 1, 1, 1, true, '2020-07-10', 1, true);

-- EVALUADOR EVALUACION
INSERT INTO eti.evaluador_evaluacion (id, evaluador_id, evaluacion_id) VALUES (1, 1, 1);
INSERT INTO eti.evaluador_evaluacion (id, evaluador_id, evaluacion_id) VALUES (2, 1, 1);
INSERT INTO eti.evaluador_evaluacion (id, evaluador_id, evaluacion_id) VALUES (3, 1, 1);
INSERT INTO eti.evaluador_evaluacion (id, evaluador_id, evaluacion_id) VALUES (4, 1, 1);
INSERT INTO eti.evaluador_evaluacion (id, evaluador_id, evaluacion_id) VALUES (5, 1, 1);
INSERT INTO eti.evaluador_evaluacion (id, evaluador_id, evaluacion_id) VALUES (6, 1, 1);
INSERT INTO eti.evaluador_evaluacion (id, evaluador_id, evaluacion_id) VALUES (7, 1, 1);
INSERT INTO eti.evaluador_evaluacion (id, evaluador_id, evaluacion_id) VALUES (8, 1, 1);
