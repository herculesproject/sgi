...
INSERT INTO eti.peticion_evaluacion
  (id, titulo, codigo, solicitud_convocatoria_ref, tipo_actividad_id, fuente_financiacion, fecha_inicio, fecha_fin, resumen, valor_social, otro_valor_social, objetivos, dis_metodologico, externo, tiene_fondos_propios, persona_ref, activo)
...
VALUES
  (1, 'numRef-001', 1, 1, 'Memoria001', 'user-001', 1, 1, '2020-08-01', false, 1, 3, true);
...
INSERT INTO eti.evaluacion
  (id, memoria_id, dictamen_id, convocatoria_reunion_id, tipo_evaluacion_id, es_rev_minima, fecha_dictamen, version, activo)
VALUES(1, 1, 1, 1, null, true, '2020-08-01', 2, true);
INSERT INTO eti.evaluacion
  (id, memoria_id, dictamen_id, convocatoria_reunion_id, tipo_evaluacion_id, es_rev_minima, fecha_dictamen, version, activo)
VALUES(2, 1, 1, 2, null, true, '2020-08-01', 2, true);
INSERT INTO eti.evaluacion
  (id, memoria_id, dictamen_id, convocatoria_reunion_id, tipo_evaluacion_id, es_rev_minima, fecha_dictamen, version, activo)
VALUES(3, 1, 1, 1, null, true, '2020-08-01', 2, true);
INSERT INTO eti.evaluacion
  (id, memoria_id, dictamen_id, convocatoria_reunion_id, tipo_evaluacion_id, es_rev_minima, fecha_dictamen, version, activo)
VALUES(4, 1, 1, 2, null, true, '2020-08-01', 2, true);
INSERT INTO eti.evaluacion
  (id, memoria_id, dictamen_id, convocatoria_reunion_id, tipo_evaluacion_id, es_rev_minima, fecha_dictamen, version, activo)
VALUES(5, 1, 1, 1, null, true, '2020-08-01', 2, true);