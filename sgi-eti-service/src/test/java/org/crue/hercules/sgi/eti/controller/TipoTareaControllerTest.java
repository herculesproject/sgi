...
public class TipoTareaControllerTest {
  ...
  public void getTipoTarea_WithId_ReturnsTipoTarea() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get(TIPO_TAREA_CONTROLLER_BASE_PATH + PATH_PARAMETER_ID, 1L))
  ...
  public void newTipoTarea_ReturnsTipoTarea() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.post(TIPO_TAREA_CONTROLLER_BASE_PATH).contentType(MediaType.APPLICATION_JSON)
  ...
  public void replaceTipoTarea_ReturnsTipoTarea() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.put(TIPO_TAREA_CONTROLLER_BASE_PATH + PATH_PARAMETER_ID, 1L)
            .contentType(MediaType.APPLICATION_JSON).content(replaceTipoTareaJson))
        .andDo(MockMvcResultHandlers.print())
  ...
  public void findAll_Unlimited_ReturnsFullTipoTareaList() throws Exception {
    ...
    // when: find unlimited
    mockMvc.perform(MockMvcRequestBuilders.get(TIPO_TAREA_CONTROLLER_BASE_PATH).accept(MediaType.APPLICATION_JSON))
        .andDo(MockMvcResultHandlers.print())
  ...
  public void findAll_WithPaging_ReturnsTipoTareaSubList() throws Exception {
    ...
    MvcResult requestResult = mockMvc
        .perform(MockMvcRequestBuilders.get(TIPO_TAREA_CONTROLLER_BASE_PATH).header("X-Page", "3")
  ...
  public void findAll_WithSearchQuery_ReturnsFilteredTipoTareaList() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get(TIPO_TAREA_CONTROLLER_BASE_PATH).param("q", query)
