...
public class TipoActividadControllerTest {
  ...
  public void getTipoActividad_WithId_ReturnsTipoActividad() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get(TIPO_ACTIVIDAD_CONTROLLER_BASE_PATH + PATH_PARAMETER_ID, 1L))
  ...
  public void findAll_Unlimited_ReturnsFullTipoActividadList() throws Exception {
    ...
    BDDMockito
        .given(
            tipoActividadService.findAll(ArgumentMatchers.<List<QueryCriteria>>any(), ArgumentMatchers.<Pageable>any()))
        .willReturn(new PageImpl<>(tipoActividades));

    // when: find unlimited
    mockMvc.perform(MockMvcRequestBuilders.get(TIPO_ACTIVIDAD_CONTROLLER_BASE_PATH).accept(MediaType.APPLICATION_JSON))
        .andDo(MockMvcResultHandlers.print())
  ...
  public void findAll_WithPaging_ReturnsTipoActividadSubList() throws Exception {
    ...
    MvcResult requestResult = mockMvc
        .perform(MockMvcRequestBuilders.get(TIPO_ACTIVIDAD_CONTROLLER_BASE_PATH).header("X-Page", "3")
  ...
  public void findAll_WithSearchQuery_ReturnsFilteredTipoActividadList() throws Exception {
          ...
          public Page<TipoActividad> answer(InvocationOnMock invocation) throws Throwable {
            ...
            for (TipoActividad tipoActividad : tipoActividades) {
              ...
              for (QueryCriteria queryCriteria : queryCriterias) {
                Field field = ReflectionUtils.findField(TipoActividad.class, queryCriteria.getKey());
                field.setAccessible(true);
                String fieldValue = ReflectionUtils.getField(field, tipoActividad).toString();
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get(TIPO_ACTIVIDAD_CONTROLLER_BASE_PATH).param("q", query)
