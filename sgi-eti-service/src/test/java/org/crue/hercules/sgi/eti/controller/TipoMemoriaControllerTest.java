...
public class TipoMemoriaControllerTest {
  ...
  public void getTipoMemoria_WithId_ReturnsTipoMemoria() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders
            .get(ConstantesEti.TIPO_MEMORIA_CONTROLLER_BASE_PATH + ConstantesEti.PATH_PARAMETER_ID, 1L))
  ...
  public void newTipoMemoria_ReturnsTipoMemoria() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.post(ConstantesEti.TIPO_MEMORIA_CONTROLLER_BASE_PATH)
            .contentType(MediaType.APPLICATION_JSON).content(nuevoTipoMemoriaJson))
  ...
  public void replaceTipoMemoria_ReturnsTipoMemoria() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders
            .put(ConstantesEti.TIPO_MEMORIA_CONTROLLER_BASE_PATH + ConstantesEti.PATH_PARAMETER_ID, 1L)
            .contentType(MediaType.APPLICATION_JSON).content(replaceTipoMemoriaJson))
        .andDo(MockMvcResultHandlers.print())
  ...
  public void removeTipoMemoria_ReturnsOk() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders
            .delete(ConstantesEti.TIPO_MEMORIA_CONTROLLER_BASE_PATH + ConstantesEti.PATH_PARAMETER_ID, 1L)
  ...
  public void findAll_Unlimited_ReturnsFullTipoMemoriaList() throws Exception {
    ...
    BDDMockito
        .given(
            tipoMemoriaService.findAll(ArgumentMatchers.<List<QueryCriteria>>any(), ArgumentMatchers.<Pageable>any()))
        .willReturn(new PageImpl<>(tipoMemorias));

    // when: find unlimited
    mockMvc
        .perform(MockMvcRequestBuilders.get(ConstantesEti.TIPO_MEMORIA_CONTROLLER_BASE_PATH)
  ...
  public void findAll_WithPaging_ReturnsTipoMemoriaSubList() throws Exception {
    ...
    MvcResult requestResult = mockMvc
        .perform(MockMvcRequestBuilders.get(ConstantesEti.TIPO_MEMORIA_CONTROLLER_BASE_PATH).header("X-Page", "3")
  ...
  public void findAll_WithSearchQuery_ReturnsFilteredTipoMemoriaList() throws Exception {
          ...
          public Page<TipoMemoria> answer(InvocationOnMock invocation) throws Throwable {
            ...
            for (TipoMemoria tipoMemoria : tipoMemorias) {
              ...
              for (QueryCriteria queryCriteria : queryCriterias) {
                Field field = ReflectionUtils.findField(TipoMemoria.class, queryCriteria.getKey());
                field.setAccessible(true);
                String fieldValue = ReflectionUtils.getField(field, tipoMemoria).toString();
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get(ConstantesEti.TIPO_MEMORIA_CONTROLLER_BASE_PATH).param("q", query)
            .accept(MediaType.APPLICATION_JSON))
        .andDo(MockMvcResultHandlers.print())
        // then: Get a page one hundred TipoMemoria
        .andExpect(MockMvcResultMatchers.status().isOk())
