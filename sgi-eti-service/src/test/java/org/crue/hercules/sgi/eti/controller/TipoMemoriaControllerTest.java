...
public class TipoMemoriaControllerTest {
  ...
  public void getTipoMemoria_WithId_ReturnsTipoMemoria() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get(TIPO_MEMORIA_CONTROLLER_BASE_PATH + PATH_PARAMETER_ID, 1L))
  ...
  public void newTipoMemoria_ReturnsTipoMemoria() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.post(TIPO_MEMORIA_CONTROLLER_BASE_PATH).contentType(MediaType.APPLICATION_JSON)
  ...
  public void findAll_Unlimited_ReturnsFullTipoMemoriaList() throws Exception {
    ...
    // when: find unlimited
    mockMvc.perform(MockMvcRequestBuilders.get(TIPO_MEMORIA_CONTROLLER_BASE_PATH).accept(MediaType.APPLICATION_JSON))
        .andDo(MockMvcResultHandlers.print())
  ...
  public void findAll_WithPaging_ReturnsTipoMemoriaSubList() throws Exception {
    ...
    MvcResult requestResult = mockMvc
        .perform(MockMvcRequestBuilders.get(TIPO_MEMORIA_CONTROLLER_BASE_PATH).header("X-Page", "3")
  ...
  public void findAll_WithSearchQuery_ReturnsFilteredTipoMemoriaList() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get(TIPO_MEMORIA_CONTROLLER_BASE_PATH).param("q", query)
