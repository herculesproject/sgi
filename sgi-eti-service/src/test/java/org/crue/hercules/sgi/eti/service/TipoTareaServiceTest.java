...
public class TipoTareaServiceTest {
  ...
  @Test
  public void find_NotFound_ThrowsTipoTareaNotFoundException() throws Exception {
    BDDMockito.given(tipoTareaRepository.findById(1L)).willReturn(Optional.empty());

    Assertions.assertThatThrownBy(() -> tipoTareaService.findById(1L)).isInstanceOf(TipoTareaNotFoundException.class);
  }
  ...
  public void create_ReturnsTipoTarea() {
    ...
    // when: Creamos el TipoTarea
    TipoTarea tipoTareaCreado = tipoTareaService.create(tipoTareaNew);

    // then: El TipoTarea se crea correctamente
  ...
  public void update_ReturnsTipoTarea() {
    // given: Un nuevo tipo tarea con el nombre actualizado
    TipoTarea tipoTareaNombreActualizado = generarMockTipoTarea(1L, "TipoTarea1 actualizada");
    ...
    BDDMockito.given(tipoTareaRepository.save(tipoTarea)).willReturn(tipoTareaNombreActualizado);
  ...
  public void findAll_Unlimited_ReturnsFullTipoTareaList() {
    ...
    // then: Get a page with one hundred tipos tareas
  ...
  public void findAll_WithPaging_ReturnsPage() {
    ...
    // then: A Page with ten tipos tarea are returned containing
    // nombre='TipoTarea031' to 'TipoTarea040'
