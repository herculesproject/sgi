...
public class ComiteFormularioControllerTest {
  ...
  public void getComiteFormulario_WithId_ReturnsComiteFormulario() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get(COMITE_FORMULARIO_CONTROLLER_BASE_PATH + PATH_PARAMETER_ID, 1L)
  ...
  public void newComiteFormulario_ReturnsComiteFormulario() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.post(COMITE_FORMULARIO_CONTROLLER_BASE_PATH)
            ...
            .content(nuevoComiteFormularioJson))
  ...
  public void replaceComiteFormulario_ReturnsComiteFormulario() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.put(COMITE_FORMULARIO_CONTROLLER_BASE_PATH + PATH_PARAMETER_ID, 1L)
            .with(SecurityMockMvcRequestPostProcessors.csrf()).contentType(MediaType.APPLICATION_JSON)
            .content(replaceComiteFormularioJson))
        .andDo(MockMvcResultHandlers.print())
