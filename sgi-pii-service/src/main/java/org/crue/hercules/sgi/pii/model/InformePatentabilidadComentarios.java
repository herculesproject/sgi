...
@AllArgsConstructor
@Embeddable
public class InformePatentabilidadComentarios implements Serializable, I18nFieldValue {
  /**
   * Serial version
   */
  ...
  /** Comentarios */
  @Column(name = "value_", length = InformePatentabilidad.LONG_TEXT_LENGTH, nullable = false)
  @NotNull
