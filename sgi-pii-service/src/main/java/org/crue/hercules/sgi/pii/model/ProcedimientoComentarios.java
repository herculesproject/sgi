...
@AllArgsConstructor
@Embeddable
public class ProcedimientoComentarios implements Serializable, I18nFieldValue {
  /**
   * Serial version
   */
  ...
  /** Comentarios */
  @Column(name = "value_", length = Procedimiento.COMENTARIOS_MAX_LENGTH, nullable = false)
  @NotNull
