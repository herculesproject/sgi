...
@AllArgsConstructor
@Embeddable
public class InformePatentabilidadNombre implements Serializable, I18nFieldValue {
  /**
   * Serial version
   */
  ...
  /** Nombre */
  @Column(name = "value_", length = InformePatentabilidad.NOMBRE_LENGTH, nullable = false)
  @NotNull
