...
public class CnfI18nConfigProvider implements I18nConfigProvider {
  ...
  @Override
  @Scheduled(fixedDelayString = "#{@'sgi-org.crue.hercules.sgi.rep.config.SgiConfigProperties'.i18nConfigRefreshInterval}", timeUnit = TimeUnit.SECONDS)
  public void refresh() {
    updateData();
  }
