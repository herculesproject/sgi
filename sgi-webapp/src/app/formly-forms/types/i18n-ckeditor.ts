...
import { I18nCkeditorComponent } from '@components/i18n/i18n-ckeditor/i18n-ckeditor.component';
...
export class I18nCkeditorTypeComponent extends FieldType implements OnInit, OnDestroy {

  @ViewChild(I18nCkeditorComponent, { static: true })
  private readonly ckeditor: I18nCkeditorComponent;
  ...
  ngOnInit(): void {
    ...
    this.ckeditor.editValueChanges.pipe(
