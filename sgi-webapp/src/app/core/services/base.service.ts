...
export class BaseService<T> {
  ...
  constructor(
    ...
    this.logger.debug(
      BaseService.name,
      'constructor(protected logger: NGXLogger, protected http: HttpClient, mapping: string)',
      'start'
    );
  ...
  public create(object: T): Observable<T> {
    ...
    return this.http
      .post<any>(this.apiEndpoint, postBody, {
      ...
      .pipe(
        map((res) => {
          this.logger.debug(BaseService.name, 'create(object: T)', 'end');
          return this.mapObject(res);
        }),
        catchError((error) => {
  ...
  public update(object: T, id: any): Observable<T> {
    ...
    return this.http
      .put<any>(this.apiEndpoint + '/' + id, putBody, {
        headers: new HttpHeaders()
          .set('Accept', 'application/json')
          .set('Content-Type', 'application/json'),
      })
  ...
  public delete(id: any): Observable<T> {
    ...
    return this.http
      .delete<any>(this.apiEndpoint + '/' + id, {
        headers: new HttpHeaders()
          .set('Accept', 'application/json')
          .set('Content-Type', 'application/json'),
      })
      .pipe(
        map((res) => {
          this.logger.debug(BaseService.name, 'delete(id: any)', 'end');
          return res;
        }),
        catchError((error) => {
          this.logger.error(BaseService.name, error);
  ...
  public findAll(filtro?: any): Observable<T[]> {
    ...
    return this.http
      ...
      .pipe(
        map((res) => {
          this.logger.debug(BaseService.name, 'findAll()', 'end');
  ...
  public getOne(id: any): Observable<T> {
    ...
    return this.http
      .get<T>(this.apiEndpoint + '/' + id, {
        headers: new HttpHeaders().set('Accept', 'application/json'),
      })
      .pipe(
        map((res) => {
          this.logger.debug(BaseService.name, 'getOne(id: any)', 'end');
          return this.mapObject(res);
        }),
        catchError((error) => {
