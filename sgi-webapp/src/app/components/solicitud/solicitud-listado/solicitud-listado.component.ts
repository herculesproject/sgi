import { Component, OnInit, ViewChild, OnDestroy, Input, SimpleChanges, Output, EventEmitter } from '@angular/core';
...
export class SolicitudListadoComponent implements OnInit, OnDestroy {
  UrlUtils = UrlUtils;
