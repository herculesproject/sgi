...
import { TipoReservableCrearComponent } from './tipo-reservable-crear.component';


describe('TipoReservableCrearComponent', () => {
  let component: TipoReservableCrearComponent;
  let fixture: ComponentFixture<TipoReservableCrearComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TipoReservableCrearComponent);
  ...
  it('Debe crear el componente', () => {
    ...
    fixture.whenStable().then(() => {
      ...
      expect(titulo.innerHTML).toBe(i18n.cat['tipo-reservable'].crear.titulo);
    });
  });
});
