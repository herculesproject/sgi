...
@Injectable()
@Pipe({
  name: 'i18nFieldTooltip',
  pure: false // required to update the value when the promise is resolved
})
export class I18nFieldTooltipPipe implements PipeTransform, OnDestroy {
  value: string = '';
  lastLang: Language;
  ...
  private getFieldValue(field: I18nFieldValue[] | I18nFieldValueResponse[], lang: Language): string {
    ...
    return lang === fieldValue.lang ? fieldValue.value : `[${fieldValue.lang.codeExtended}] ${fieldValue.value}`;
  }
