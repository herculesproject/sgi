...
@Component({
  selector: 'sgi-i18n-display-field-linea-investigacion',
  templateUrl: './i18n-display-field-linea-investigacion.component.html',
  styleUrls: ['./i18n-display-field-linea-investigacion.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class I18nDisplayFieldLineaInvestigacionComponent implements OnDestroy {
  ...
  private resolveValue() {
    if (this._lang) {
      this._field = this._field.filter(v => v.lang.code == this._lang);
    }
