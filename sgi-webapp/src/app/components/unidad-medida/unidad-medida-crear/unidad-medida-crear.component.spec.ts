...
import { UnidadMedidaCrearComponent } from './unidad-medida-crear.component';

describe('UnidadMedidaCrearComponent', () => {
  let component: UnidadMedidaCrearComponent;
  let fixture: ComponentFixture<UnidadMedidaCrearComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(UnidadMedidaCrearComponent);
  ...
  it('Debe crear el componente', () => {
    ...
    fixture.whenStable().then(() => {
      ...
      expect(titulo.innerHTML).toBe(i18n['unidad-medida'].agregar.titulo);
    });
  });
});
