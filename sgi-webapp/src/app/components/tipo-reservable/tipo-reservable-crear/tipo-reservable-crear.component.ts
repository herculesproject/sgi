...
export class TipoReservableCrearComponent implements OnInit, OnDestroy {
      ...
      .subscribe(
        ...
        () => {
          ...
          if (id) {
            ...
            this.router.navigateByUrl(UrlUtils.tipoReservables).then();
          }
          this.logger.debug(
            TipoReservableCrearComponent.name,
            'getTipoReservable()',
  ...
  /**
   * Envia los datos al back para agregar un tipo reservable
   */
  ...
  private agregarTipoReservable() {
    ...
    this.tipoReservableServiceCreateSubscription = this.tipoReservableService.create(this.tipoReservable).subscribe(
      ...
      () => {
        this.snackBarService.mostrarMensajeError(
          this.traductor.getTexto('tipo-reservable.agregar.error')
        );
        this.desactivarAceptar = false;
        this.logger.debug(
          TipoReservableCrearComponent.name,
