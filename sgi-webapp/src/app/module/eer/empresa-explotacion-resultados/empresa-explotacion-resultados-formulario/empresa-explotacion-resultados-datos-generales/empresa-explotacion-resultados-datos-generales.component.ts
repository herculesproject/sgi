...
import { ESTADO_EMPRESA_EXPLOTACION_RESULTADOS_MAP, EstadoEmpresa, IEmpresaExplotacionResultados, TIPO_EMPRESA_EXPLOTACION_RESULTADOS_MAP, TipoEmpresa } from '@core/models/eer/empresa-explotacion-resultados';
