...
import { IConvocatoriaPartidaPresupuestaria, TIPO_PARTIDA_MAP } from '@core/models/csp/convocatoria-partida-presupuestaria';
...
import { ConvocatoriaPartidaPresupuestariaModalComponent, IConvocatoriaPartidaPresupuestariaModalData } from '../../modals/convocatoria-partidas-presupuestarias-modal/convocatoria-partidas-presupuestarias-modal.component';
...
export class ConvocatoriaPartidaPresupuestariaComponent extends FragmentComponent implements OnInit, OnDestroy {
  ...
  openModalPartidaPresupuestaria(partidaPresupuestariaActualizar?: StatusWrapper<IConvocatoriaPartidaPresupuestaria>): void {
    const modalData: IConvocatoriaPartidaPresupuestariaModalData = {
      convocatoriaPartidaPresupuestaria: partidaPresupuestariaActualizar?.value ?? {} as IConvocatoriaPartidaPresupuestaria,
      convocatoriaPartidaPresupuestariaList: this.dataSource.data,
    ...
    const dialogRef = this.matDialog.open(ConvocatoriaPartidaPresupuestariaModalComponent, config);
