...
const MSG_EDIT_TITLE = marker('csp.solicitud-proyecto-presupuesto.editar.titulo');
const MSG_NEW_TITLE = marker('csp.solicitud-proyecto-presupuesto.crear.titulo');
