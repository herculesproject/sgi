...
import { CalendarioFacturacionCspService } from './calendario-facturacion-csp.service';
...
@NgModule({
  ...
  providers: [
    ...
    { provide: CalendarioFacturacionService, useClass: CalendarioFacturacionCspService }
  ]
})
