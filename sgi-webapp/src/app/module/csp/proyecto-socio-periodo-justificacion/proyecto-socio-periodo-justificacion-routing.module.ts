...
import { PROYECTO_SOCIO_PERIODO_JUSTIFICACION_DATA_KEY, ProyectoSocioPeriodoJustificacionDataResolver } from './proyecto-socio-periodo-justificacion-data.resolver';
