...
export enum ConfigCsp {
  ...
  CSP_INV_PROYECTO_VISTA_AMPLIADA_IP_ENABLED = 'invProyectoVistaAmpliadaIpEnabled',
  ...
  CSP_PROYECTO_AREAS_CONOCIMIENTO_ENABLED = 'proyectoAreasConocimientoEnabled',
  ...
  CSP_PROYECTO_UNIDADES_VINCULACION_ENABLED = 'proyectoUnidadesVinculacionEnabled',
...
export class ConfigCspComponent extends AbstractMenuContentComponent {
  ...
  private readonly _CONFIG_MAP: Map<ConfigCsp, IConfigOptions> = new Map([
    [ConfigCsp.CSP_INV_PROYECTO_VISTA_AMPLIADA_IP_ENABLED, { type: ConfigType.SELECT, label: marker(`adm.config.csp.CSP_INV_PROYECTO_VISTA_AMPLIADA_IP_ENABLED`), options: this.getBooleanValues(), required: true, module: ConfigModule.CSP, description: marker(`adm.config.csp.CSP_INV_PROYECTO_VISTA_AMPLIADA_IP_ENABLED.description`) }],
    [ConfigCsp.CSP_INV_EJECUCION_ECONOMICA_VISTA_IP_ENABLED, { type: ConfigType.SELECT, label: marker(`adm.config.csp.CSP_INV_EJECUCION_ECONOMICA_VISTA_IP_ENABLED`), options: this.getBooleanValues(), required: true, module: ConfigModule.CSP, description: marker(`adm.config.csp.CSP_INV_EJECUCION_ECONOMICA_VISTA_IP_ENABLED.description`) }],
    ...
    [ConfigCsp.CSP_PROYECTO_UNIDADES_VINCULACION_ENABLED, { type: ConfigType.SELECT, label: marker(`adm.config.csp.CSP_PROYECTO_UNIDADES_VINCULACION_ENABLED`), options: this.getBooleanValues(), required: true, module: ConfigModule.CSP, description: marker(`adm.config.csp.CSP_PROYECTO_UNIDADES_VINCULACION_ENABLED.description`) }],
    [ConfigCsp.CSP_PROYECTO_AREAS_CONOCIMIENTO_ENABLED, { type: ConfigType.SELECT, label: marker(`adm.config.csp.CSP_PROYECTO_AREAS_CONOCIMIENTO_ENABLED`), options: this.getBooleanValues(), required: true, module: ConfigModule.CSP, description: marker(`adm.config.csp.CSP_PROYECTO_AREAS_CONOCIMIENTO_ENABLED.description`) }],
