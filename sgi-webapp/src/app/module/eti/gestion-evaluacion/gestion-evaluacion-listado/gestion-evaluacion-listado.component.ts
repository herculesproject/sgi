...
@Component({
  selector: 'sgi-gestion-evaluacion-listado',
  templateUrl: './gestion-evaluacion-listado.component.html',
  styleUrls: ['./gestion-evaluacion-listado.component.scss']
})
export class GestionEvaluacionListadoComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit(): void {
    this.logger.debug(GestionEvaluacionListadoComponent.name, 'ngOnInit()', 'start');
    ...
    this.logger.debug(GestionEvaluacionListadoComponent.name, 'ngOnInit()', 'end');
  }

  ngAfterViewInit(): void {
    this.logger.debug(GestionEvaluacionListadoComponent.name, 'ngAfterViewInit()', 'start');
    ...
    this.logger.debug(GestionEvaluacionListadoComponent.name, 'ngAfterViewInit()', 'end');
  }

  private loadTable(reset?: boolean) {
    this.logger.debug(GestionEvaluacionListadoComponent.name, 'loadTable()', 'start');
      ...
      .pipe(
        switchMap((response) => {
          ...
          if (response.items) {
            ...
            this.logger.debug(GestionEvaluacionListadoComponent.name, 'loadTable()', 'end');
  ...
  private buildFilters(): SgiRestFilter[] {
    this.logger.debug(GestionEvaluacionListadoComponent.name, 'buildFilters()', 'start');

    this.filter = [];
    if (this.buscadorFormGroup.controls.comite.value) {
      this.logger.debug(GestionEvaluacionListadoComponent.name, 'buildFilters()', 'comite');
    ...
    if (this.buscadorFormGroup.controls.fechaEvaluacionInicio.value) {
      this.logger.debug(GestionEvaluacionListadoComponent.name, 'buildFilters()', 'fechaEvaluacionInicio');
    ...
    if (this.buscadorFormGroup.controls.fechaEvaluacionFin.value) {
      this.logger.debug(GestionEvaluacionListadoComponent.name, 'buildFilters()', 'fechaEvaluacionFin');
    ...
    if (this.buscadorFormGroup.controls.referenciaMemoria.value) {
      this.logger.debug(GestionEvaluacionListadoComponent.name, 'buildFilters()', 'referenciaMemoria');
    ...
    if (this.buscadorFormGroup.controls.tipoConvocatoriaReunion.value) {
      this.logger.debug(GestionEvaluacionListadoComponent.name, 'buildFilters()', 'tipoConvocatoriaReunion');
    ...
    if (this.personaRefSolicitante) {
      this.logger.debug(GestionEvaluacionListadoComponent.name, 'buildFilters()', 'solicitante');
    ...
    this.logger.debug(GestionEvaluacionListadoComponent.name, 'buildFilters()', 'end');
    return this.filter;
  }
   ...
   */
  getComites(): void {
    this.logger.debug(GestionEvaluacionListadoComponent.name,
      'getComites()',
      'start');
   ...
   */
  public setPersona(personaRef: string) {
    this.personaRefSolicitante = personaRef;
  }
