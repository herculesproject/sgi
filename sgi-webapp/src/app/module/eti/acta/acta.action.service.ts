...
import { ActaAsistentesFragment } from './acta-formulario/acta-asistentes/acta-asistentes-listado/acta-asistentes-listado.fragment';
...
export class ActaActionService extends ActionService {
  ...
  constructor(fb: FormBuilder, route: ActivatedRoute, service: ActaService, convocatoriaReunionService: ConvocatoriaReunionService, personaFisicaService: PersonaFisicaService, asistenteService: AsistenteService) {
    super();
    this.acta = {} as IActa;
    ...
    this.asistentes = new ActaAsistentesFragment(this.acta?.convocatoriaReunion?.id, convocatoriaReunionService, personaFisicaService, asistenteService);
