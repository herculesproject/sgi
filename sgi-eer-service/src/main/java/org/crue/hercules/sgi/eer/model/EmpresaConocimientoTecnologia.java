...
@Builder
@Embeddable
public class EmpresaConocimientoTecnologia implements Serializable, I18nFieldValue {
  /**
   * Serial version
   */
  ...
  @Column(name = "value_", length = Empresa.CONOCIMIENTO_TECNOLOGIA_LENGTH, nullable = false)
  @NotBlank
