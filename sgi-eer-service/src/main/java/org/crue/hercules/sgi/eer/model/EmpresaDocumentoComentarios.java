...
@AllArgsConstructor
@Embeddable
public class EmpresaDocumentoComentarios implements Serializable, I18nFieldValue {
  /**
   * Serial version
   */
  ...
  /** Comentarios */
  @Column(name = "value_", length = BaseEntity.LONG_TEXT_LENGTH, nullable = false)
  @NotNull
